...
typedef enum of_object_id_e {
    ...
    OF_BSN_SET_IP_MASK = 22,
    OF_BSN_SET_L2_TABLE_REPLY = 23,
    OF_BSN_SET_L2_TABLE_REQUEST = 24,
    OF_BSN_SET_MIRRORING = 25,
    OF_BSN_SET_PKTIN_SUPPRESSION = 26,
    OF_BSN_SHELL_COMMAND = 27,
    OF_BSN_SHELL_OUTPUT = 28,
    OF_BSN_SHELL_STATUS = 29,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 30,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 31,
    OF_BSN_VIRTUAL_PORT_REMOVE = 32,
    OF_DESC_STATS_REPLY = 33,
    OF_DESC_STATS_REQUEST = 34,
    OF_ECHO_REPLY = 35,
    OF_ECHO_REQUEST = 36,
    OF_ERROR_MSG = 37,
    OF_EXPERIMENTER = 38,
    OF_EXPERIMENTER_STATS_REPLY = 39,
    OF_EXPERIMENTER_STATS_REQUEST = 40,
    OF_FEATURES_REPLY = 41,
    OF_FEATURES_REQUEST = 42,
    OF_FLOW_ADD = 43,
    OF_FLOW_DELETE = 44,
    OF_FLOW_DELETE_STRICT = 45,
    OF_FLOW_MODIFY = 46,
    OF_FLOW_MODIFY_STRICT = 47,
    OF_FLOW_REMOVED = 48,
    OF_FLOW_STATS_REPLY = 49,
    OF_FLOW_STATS_REQUEST = 50,
    OF_GET_CONFIG_REPLY = 51,
    OF_GET_CONFIG_REQUEST = 52,
    OF_GROUP_DESC_STATS_REPLY = 53,
    OF_GROUP_DESC_STATS_REQUEST = 54,
    OF_GROUP_FEATURES_STATS_REPLY = 55,
    OF_GROUP_FEATURES_STATS_REQUEST = 56,
    OF_GROUP_MOD = 57,
    OF_GROUP_STATS_REPLY = 58,
    OF_GROUP_STATS_REQUEST = 59,
    OF_HELLO = 60,
    OF_METER_CONFIG_STATS_REPLY = 61,
    OF_METER_CONFIG_STATS_REQUEST = 62,
    OF_METER_FEATURES_STATS_REPLY = 63,
    OF_METER_FEATURES_STATS_REQUEST = 64,
    OF_METER_MOD = 65,
    OF_METER_STATS_REPLY = 66,
    OF_METER_STATS_REQUEST = 67,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 68,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 69,
    OF_PACKET_IN = 70,
    OF_PACKET_OUT = 71,
    OF_PORT_DESC_STATS_REPLY = 72,
    OF_PORT_DESC_STATS_REQUEST = 73,
    OF_PORT_MOD = 74,
    OF_PORT_STATS_REPLY = 75,
    OF_PORT_STATS_REQUEST = 76,
    OF_PORT_STATUS = 77,
    OF_QUEUE_GET_CONFIG_REPLY = 78,
    OF_QUEUE_GET_CONFIG_REQUEST = 79,
    OF_QUEUE_STATS_REPLY = 80,
    OF_QUEUE_STATS_REQUEST = 81,
    OF_ROLE_REPLY = 82,
    OF_ROLE_REQUEST = 83,
    OF_SET_CONFIG = 84,
    OF_TABLE_FEATURES_STATS_REPLY = 85,
    OF_TABLE_FEATURES_STATS_REQUEST = 86,
    OF_TABLE_MOD = 87,
    OF_TABLE_STATS_REPLY = 88,
    OF_TABLE_STATS_REQUEST = 89,

    /* Non-message objects */
    OF_ACTION = 90,
    OF_ACTION_BSN_MIRROR = 91,
    OF_ACTION_BSN_SET_TUNNEL_DST = 92,
    OF_ACTION_COPY_TTL_IN = 93,
    OF_ACTION_COPY_TTL_OUT = 94,
    OF_ACTION_DEC_MPLS_TTL = 95,
    OF_ACTION_DEC_NW_TTL = 96,
    OF_ACTION_ENQUEUE = 97,
    OF_ACTION_EXPERIMENTER = 98,
    OF_ACTION_GROUP = 99,
    OF_ACTION_HEADER = 100,
    OF_ACTION_ID = 101,
    OF_ACTION_ID_BSN_MIRROR = 102,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 103,
    OF_ACTION_ID_COPY_TTL_IN = 104,
    OF_ACTION_ID_COPY_TTL_OUT = 105,
    OF_ACTION_ID_DEC_MPLS_TTL = 106,
    OF_ACTION_ID_DEC_NW_TTL = 107,
    OF_ACTION_ID_EXPERIMENTER = 108,
    OF_ACTION_ID_GROUP = 109,
    OF_ACTION_ID_HEADER = 110,
    OF_ACTION_ID_NICIRA_DEC_TTL = 111,
    OF_ACTION_ID_OUTPUT = 112,
    OF_ACTION_ID_POP_MPLS = 113,
    OF_ACTION_ID_POP_PBB = 114,
    OF_ACTION_ID_POP_VLAN = 115,
    OF_ACTION_ID_PUSH_MPLS = 116,
    OF_ACTION_ID_PUSH_PBB = 117,
    OF_ACTION_ID_PUSH_VLAN = 118,
    OF_ACTION_ID_SET_FIELD = 119,
    OF_ACTION_ID_SET_MPLS_TTL = 120,
    OF_ACTION_ID_SET_NW_TTL = 121,
    OF_ACTION_ID_SET_QUEUE = 122,
    OF_ACTION_NICIRA_DEC_TTL = 123,
    OF_ACTION_OUTPUT = 124,
    OF_ACTION_POP_MPLS = 125,
    OF_ACTION_POP_PBB = 126,
    OF_ACTION_POP_VLAN = 127,
    OF_ACTION_PUSH_MPLS = 128,
    OF_ACTION_PUSH_PBB = 129,
    OF_ACTION_PUSH_VLAN = 130,
    OF_ACTION_SET_DL_DST = 131,
    OF_ACTION_SET_DL_SRC = 132,
    OF_ACTION_SET_FIELD = 133,
    OF_ACTION_SET_MPLS_LABEL = 134,
    OF_ACTION_SET_MPLS_TC = 135,
    OF_ACTION_SET_MPLS_TTL = 136,
    OF_ACTION_SET_NW_DST = 137,
    OF_ACTION_SET_NW_ECN = 138,
    OF_ACTION_SET_NW_SRC = 139,
    OF_ACTION_SET_NW_TOS = 140,
    OF_ACTION_SET_NW_TTL = 141,
    OF_ACTION_SET_QUEUE = 142,
    OF_ACTION_SET_TP_DST = 143,
    OF_ACTION_SET_TP_SRC = 144,
    OF_ACTION_SET_VLAN_PCP = 145,
    OF_ACTION_SET_VLAN_VID = 146,
    OF_ACTION_STRIP_VLAN = 147,
    OF_BSN_INTERFACE = 148,
    OF_BSN_VPORT = 149,
    OF_BSN_VPORT_HEADER = 150,
    OF_BSN_VPORT_Q_IN_Q = 151,
    OF_BUCKET = 152,
    OF_BUCKET_COUNTER = 153,
    OF_EXPERIMENTER_MULTIPART_HEADER = 154,
    OF_FLOW_STATS_ENTRY = 155,
    OF_GROUP_DESC_STATS_ENTRY = 156,
    OF_GROUP_STATS_ENTRY = 157,
    OF_HEADER = 158,
    OF_HELLO_ELEM = 159,
    OF_HELLO_ELEM_HEADER = 160,
    OF_HELLO_ELEM_VERSIONBITMAP = 161,
    OF_INSTRUCTION = 162,
    OF_INSTRUCTION_APPLY_ACTIONS = 163,
    OF_INSTRUCTION_CLEAR_ACTIONS = 164,
    OF_INSTRUCTION_EXPERIMENTER = 165,
    OF_INSTRUCTION_GOTO_TABLE = 166,
    OF_INSTRUCTION_HEADER = 167,
    OF_INSTRUCTION_METER = 168,
    OF_INSTRUCTION_WRITE_ACTIONS = 169,
    OF_INSTRUCTION_WRITE_METADATA = 170,
    OF_MATCH_V1 = 171,
    OF_MATCH_V2 = 172,
    OF_MATCH_V3 = 173,
    OF_METER_BAND = 174,
    OF_METER_BAND_DROP = 175,
    OF_METER_BAND_DSCP_REMARK = 176,
    OF_METER_BAND_EXPERIMENTER = 177,
    OF_METER_BAND_HEADER = 178,
    OF_METER_BAND_STATS = 179,
    OF_METER_CONFIG = 180,
    OF_METER_FEATURES = 181,
    OF_METER_STATS = 182,
    OF_OXM = 183,
    OF_OXM_ARP_OP = 184,
    OF_OXM_ARP_OP_MASKED = 185,
    OF_OXM_ARP_SHA = 186,
    OF_OXM_ARP_SHA_MASKED = 187,
    OF_OXM_ARP_SPA = 188,
    OF_OXM_ARP_SPA_MASKED = 189,
    OF_OXM_ARP_THA = 190,
    OF_OXM_ARP_THA_MASKED = 191,
    OF_OXM_ARP_TPA = 192,
    OF_OXM_ARP_TPA_MASKED = 193,
    OF_OXM_ETH_DST = 194,
    OF_OXM_ETH_DST_MASKED = 195,
    OF_OXM_ETH_SRC = 196,
    OF_OXM_ETH_SRC_MASKED = 197,
    OF_OXM_ETH_TYPE = 198,
    OF_OXM_ETH_TYPE_MASKED = 199,
    OF_OXM_HEADER = 200,
    OF_OXM_ICMPV4_CODE = 201,
    OF_OXM_ICMPV4_CODE_MASKED = 202,
    OF_OXM_ICMPV4_TYPE = 203,
    OF_OXM_ICMPV4_TYPE_MASKED = 204,
    OF_OXM_ICMPV6_CODE = 205,
    OF_OXM_ICMPV6_CODE_MASKED = 206,
    OF_OXM_ICMPV6_TYPE = 207,
    OF_OXM_ICMPV6_TYPE_MASKED = 208,
    OF_OXM_IN_PHY_PORT = 209,
    OF_OXM_IN_PHY_PORT_MASKED = 210,
    OF_OXM_IN_PORT = 211,
    OF_OXM_IN_PORT_MASKED = 212,
    OF_OXM_IP_DSCP = 213,
    OF_OXM_IP_DSCP_MASKED = 214,
    OF_OXM_IP_ECN = 215,
    OF_OXM_IP_ECN_MASKED = 216,
    OF_OXM_IP_PROTO = 217,
    OF_OXM_IP_PROTO_MASKED = 218,
    OF_OXM_IPV4_DST = 219,
    OF_OXM_IPV4_DST_MASKED = 220,
    OF_OXM_IPV4_SRC = 221,
    OF_OXM_IPV4_SRC_MASKED = 222,
    OF_OXM_IPV6_DST = 223,
    OF_OXM_IPV6_DST_MASKED = 224,
    OF_OXM_IPV6_FLABEL = 225,
    OF_OXM_IPV6_FLABEL_MASKED = 226,
    OF_OXM_IPV6_ND_SLL = 227,
    OF_OXM_IPV6_ND_SLL_MASKED = 228,
    OF_OXM_IPV6_ND_TARGET = 229,
    OF_OXM_IPV6_ND_TARGET_MASKED = 230,
    OF_OXM_IPV6_ND_TLL = 231,
    OF_OXM_IPV6_ND_TLL_MASKED = 232,
    OF_OXM_IPV6_SRC = 233,
    OF_OXM_IPV6_SRC_MASKED = 234,
    OF_OXM_METADATA = 235,
    OF_OXM_METADATA_MASKED = 236,
    OF_OXM_MPLS_LABEL = 237,
    OF_OXM_MPLS_LABEL_MASKED = 238,
    OF_OXM_MPLS_TC = 239,
    OF_OXM_MPLS_TC_MASKED = 240,
    OF_OXM_SCTP_DST = 241,
    OF_OXM_SCTP_DST_MASKED = 242,
    OF_OXM_SCTP_SRC = 243,
    OF_OXM_SCTP_SRC_MASKED = 244,
    OF_OXM_TCP_DST = 245,
    OF_OXM_TCP_DST_MASKED = 246,
    OF_OXM_TCP_SRC = 247,
    OF_OXM_TCP_SRC_MASKED = 248,
    OF_OXM_UDP_DST = 249,
    OF_OXM_UDP_DST_MASKED = 250,
    OF_OXM_UDP_SRC = 251,
    OF_OXM_UDP_SRC_MASKED = 252,
    OF_OXM_VLAN_PCP = 253,
    OF_OXM_VLAN_PCP_MASKED = 254,
    OF_OXM_VLAN_VID = 255,
    OF_OXM_VLAN_VID_MASKED = 256,
    OF_PACKET_QUEUE = 257,
    OF_PORT_DESC = 258,
    OF_PORT_STATS_ENTRY = 259,
    OF_QUEUE_PROP = 260,
    OF_QUEUE_PROP_EXPERIMENTER = 261,
    OF_QUEUE_PROP_HEADER = 262,
    OF_QUEUE_PROP_MAX_RATE = 263,
    OF_QUEUE_PROP_MIN_RATE = 264,
    OF_QUEUE_STATS_ENTRY = 265,
    OF_TABLE_FEATURE_PROP = 266,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 267,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 268,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 269,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 270,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 271,
    OF_TABLE_FEATURE_PROP_HEADER = 272,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 273,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 274,
    OF_TABLE_FEATURE_PROP_MATCH = 275,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 276,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 277,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 278,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 279,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 280,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 281,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 282,
    OF_TABLE_FEATURES = 283,
    OF_TABLE_STATS_ENTRY = 284,
    OF_UINT32 = 285,
    OF_UINT8 = 286,

    /* List objects */
    OF_LIST_ACTION = 287,
    OF_LIST_ACTION_ID = 288,
    OF_LIST_BSN_INTERFACE = 289,
    OF_LIST_BUCKET = 290,
    OF_LIST_BUCKET_COUNTER = 291,
    OF_LIST_FLOW_STATS_ENTRY = 292,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 293,
    OF_LIST_GROUP_STATS_ENTRY = 294,
    OF_LIST_HELLO_ELEM = 295,
    OF_LIST_INSTRUCTION = 296,
    OF_LIST_METER_BAND = 297,
    OF_LIST_METER_BAND_STATS = 298,
    OF_LIST_METER_STATS = 299,
    OF_LIST_OXM = 300,
    OF_LIST_PACKET_QUEUE = 301,
    OF_LIST_PORT_DESC = 302,
    OF_LIST_PORT_STATS_ENTRY = 303,
    OF_LIST_QUEUE_PROP = 304,
    OF_LIST_QUEUE_STATS_ENTRY = 305,
    OF_LIST_TABLE_FEATURE_PROP = 306,
    OF_LIST_TABLE_FEATURES = 307,
    OF_LIST_TABLE_STATS_ENTRY = 308,
    OF_LIST_UINT32 = 309,
    OF_LIST_UINT8 = 310,
...
#define OF_MESSAGE_OBJECT_COUNT 90
