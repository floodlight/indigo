...
typedef enum of_object_id_e {
    ...
    OF_BSN_GET_MIRRORING_REPLY = 12,
    OF_BSN_GET_MIRRORING_REQUEST = 13,
    OF_BSN_SET_IP_MASK = 14,
    OF_BSN_SET_MIRRORING = 15,
    OF_BSN_SHELL_COMMAND = 16,
    OF_BSN_SHELL_OUTPUT = 17,
    OF_BSN_SHELL_STATUS = 18,
    OF_DESC_STATS_REPLY = 19,
    OF_DESC_STATS_REQUEST = 20,
    OF_ECHO_REPLY = 21,
    OF_ECHO_REQUEST = 22,
    OF_ERROR_MSG = 23,
    OF_EXPERIMENTER = 24,
    OF_EXPERIMENTER_STATS_REPLY = 25,
    OF_EXPERIMENTER_STATS_REQUEST = 26,
    OF_FEATURES_REPLY = 27,
    OF_FEATURES_REQUEST = 28,
    OF_FLOW_ADD = 29,
    OF_FLOW_DELETE = 30,
    OF_FLOW_DELETE_STRICT = 31,
    OF_FLOW_MODIFY = 32,
    OF_FLOW_MODIFY_STRICT = 33,
    OF_FLOW_REMOVED = 34,
    OF_FLOW_STATS_REPLY = 35,
    OF_FLOW_STATS_REQUEST = 36,
    OF_GET_CONFIG_REPLY = 37,
    OF_GET_CONFIG_REQUEST = 38,
    OF_GROUP_DESC_STATS_REPLY = 39,
    OF_GROUP_DESC_STATS_REQUEST = 40,
    OF_GROUP_FEATURES_STATS_REPLY = 41,
    OF_GROUP_FEATURES_STATS_REQUEST = 42,
    OF_GROUP_MOD = 43,
    OF_GROUP_STATS_REPLY = 44,
    OF_GROUP_STATS_REQUEST = 45,
    OF_HELLO = 46,
    OF_METER_CONFIG_STATS_REPLY = 47,
    OF_METER_CONFIG_STATS_REQUEST = 48,
    OF_METER_FEATURES_STATS_REPLY = 49,
    OF_METER_FEATURES_STATS_REQUEST = 50,
    OF_METER_MOD = 51,
    OF_METER_STATS_REPLY = 52,
    OF_METER_STATS_REQUEST = 53,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 54,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 55,
    OF_PACKET_IN = 56,
    OF_PACKET_OUT = 57,
    OF_PORT_DESC_STATS_REPLY = 58,
    OF_PORT_DESC_STATS_REQUEST = 59,
    OF_PORT_MOD = 60,
    OF_PORT_STATS_REPLY = 61,
    OF_PORT_STATS_REQUEST = 62,
    OF_PORT_STATUS = 63,
    OF_QUEUE_GET_CONFIG_REPLY = 64,
    OF_QUEUE_GET_CONFIG_REQUEST = 65,
    OF_QUEUE_STATS_REPLY = 66,
    OF_QUEUE_STATS_REQUEST = 67,
    OF_ROLE_REPLY = 68,
    OF_ROLE_REQUEST = 69,
    OF_SET_CONFIG = 70,
    OF_TABLE_FEATURES_STATS_REPLY = 71,
    OF_TABLE_FEATURES_STATS_REQUEST = 72,
    OF_TABLE_MOD = 73,
    OF_TABLE_STATS_REPLY = 74,
    OF_TABLE_STATS_REQUEST = 75,

    /* Non-message objects */
    OF_ACTION = 76,
    OF_ACTION_BSN_MIRROR = 77,
    OF_ACTION_BSN_SET_TUNNEL_DST = 78,
    OF_ACTION_COPY_TTL_IN = 79,
    OF_ACTION_COPY_TTL_OUT = 80,
    OF_ACTION_DEC_MPLS_TTL = 81,
    OF_ACTION_DEC_NW_TTL = 82,
    OF_ACTION_ENQUEUE = 83,
    OF_ACTION_EXPERIMENTER = 84,
    OF_ACTION_GROUP = 85,
    OF_ACTION_HEADER = 86,
    OF_ACTION_ID = 87,
    OF_ACTION_ID_BSN_MIRROR = 88,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 89,
    OF_ACTION_ID_COPY_TTL_IN = 90,
    OF_ACTION_ID_COPY_TTL_OUT = 91,
    OF_ACTION_ID_DEC_MPLS_TTL = 92,
    OF_ACTION_ID_DEC_NW_TTL = 93,
    OF_ACTION_ID_EXPERIMENTER = 94,
    OF_ACTION_ID_GROUP = 95,
    OF_ACTION_ID_HEADER = 96,
    OF_ACTION_ID_NICIRA_DEC_TTL = 97,
    OF_ACTION_ID_OUTPUT = 98,
    OF_ACTION_ID_POP_MPLS = 99,
    OF_ACTION_ID_POP_PBB = 100,
    OF_ACTION_ID_POP_VLAN = 101,
    OF_ACTION_ID_PUSH_MPLS = 102,
    OF_ACTION_ID_PUSH_PBB = 103,
    OF_ACTION_ID_PUSH_VLAN = 104,
    OF_ACTION_ID_SET_FIELD = 105,
    OF_ACTION_ID_SET_MPLS_TTL = 106,
    OF_ACTION_ID_SET_NW_TTL = 107,
    OF_ACTION_ID_SET_QUEUE = 108,
    OF_ACTION_NICIRA_DEC_TTL = 109,
    OF_ACTION_OUTPUT = 110,
    OF_ACTION_POP_MPLS = 111,
    OF_ACTION_POP_PBB = 112,
    OF_ACTION_POP_VLAN = 113,
    OF_ACTION_PUSH_MPLS = 114,
    OF_ACTION_PUSH_PBB = 115,
    OF_ACTION_PUSH_VLAN = 116,
    OF_ACTION_SET_DL_DST = 117,
    OF_ACTION_SET_DL_SRC = 118,
    OF_ACTION_SET_FIELD = 119,
    OF_ACTION_SET_MPLS_LABEL = 120,
    OF_ACTION_SET_MPLS_TC = 121,
    OF_ACTION_SET_MPLS_TTL = 122,
    OF_ACTION_SET_NW_DST = 123,
    OF_ACTION_SET_NW_ECN = 124,
    OF_ACTION_SET_NW_SRC = 125,
    OF_ACTION_SET_NW_TOS = 126,
    OF_ACTION_SET_NW_TTL = 127,
    OF_ACTION_SET_QUEUE = 128,
    OF_ACTION_SET_TP_DST = 129,
    OF_ACTION_SET_TP_SRC = 130,
    OF_ACTION_SET_VLAN_PCP = 131,
    OF_ACTION_SET_VLAN_VID = 132,
    OF_ACTION_STRIP_VLAN = 133,
    OF_BSN_INTERFACE = 134,
    OF_BUCKET = 135,
    OF_BUCKET_COUNTER = 136,
    OF_EXPERIMENTER_MULTIPART_HEADER = 137,
    OF_FLOW_STATS_ENTRY = 138,
    OF_GROUP_DESC_STATS_ENTRY = 139,
    OF_GROUP_STATS_ENTRY = 140,
    OF_HEADER = 141,
    OF_HELLO_ELEM = 142,
    OF_HELLO_ELEM_HEADER = 143,
    OF_HELLO_ELEM_VERSIONBITMAP = 144,
    OF_INSTRUCTION = 145,
    OF_INSTRUCTION_APPLY_ACTIONS = 146,
    OF_INSTRUCTION_CLEAR_ACTIONS = 147,
    OF_INSTRUCTION_EXPERIMENTER = 148,
    OF_INSTRUCTION_GOTO_TABLE = 149,
    OF_INSTRUCTION_HEADER = 150,
    OF_INSTRUCTION_METER = 151,
    OF_INSTRUCTION_WRITE_ACTIONS = 152,
    OF_INSTRUCTION_WRITE_METADATA = 153,
    OF_MATCH_V1 = 154,
    OF_MATCH_V2 = 155,
    OF_MATCH_V3 = 156,
    OF_METER_BAND = 157,
    OF_METER_BAND_DROP = 158,
    OF_METER_BAND_DSCP_REMARK = 159,
    OF_METER_BAND_EXPERIMENTER = 160,
    OF_METER_BAND_HEADER = 161,
    OF_METER_BAND_STATS = 162,
    OF_METER_CONFIG = 163,
    OF_METER_FEATURES = 164,
    OF_METER_STATS = 165,
    OF_OXM = 166,
    OF_OXM_ARP_OP = 167,
    OF_OXM_ARP_OP_MASKED = 168,
    OF_OXM_ARP_SHA = 169,
    OF_OXM_ARP_SHA_MASKED = 170,
    OF_OXM_ARP_SPA = 171,
    OF_OXM_ARP_SPA_MASKED = 172,
    OF_OXM_ARP_THA = 173,
    OF_OXM_ARP_THA_MASKED = 174,
    OF_OXM_ARP_TPA = 175,
    OF_OXM_ARP_TPA_MASKED = 176,
    OF_OXM_ETH_DST = 177,
    OF_OXM_ETH_DST_MASKED = 178,
    OF_OXM_ETH_SRC = 179,
    OF_OXM_ETH_SRC_MASKED = 180,
    OF_OXM_ETH_TYPE = 181,
    OF_OXM_ETH_TYPE_MASKED = 182,
    OF_OXM_EXPERIMENTER_HEADER = 183,
    OF_OXM_HEADER = 184,
    OF_OXM_ICMPV4_CODE = 185,
    OF_OXM_ICMPV4_CODE_MASKED = 186,
    OF_OXM_ICMPV4_TYPE = 187,
    OF_OXM_ICMPV4_TYPE_MASKED = 188,
    OF_OXM_ICMPV6_CODE = 189,
    OF_OXM_ICMPV6_CODE_MASKED = 190,
    OF_OXM_ICMPV6_TYPE = 191,
    OF_OXM_ICMPV6_TYPE_MASKED = 192,
    OF_OXM_IN_PHY_PORT = 193,
    OF_OXM_IN_PHY_PORT_MASKED = 194,
    OF_OXM_IN_PORT = 195,
    OF_OXM_IN_PORT_MASKED = 196,
    OF_OXM_IP_DSCP = 197,
    OF_OXM_IP_DSCP_MASKED = 198,
    OF_OXM_IP_ECN = 199,
    OF_OXM_IP_ECN_MASKED = 200,
    OF_OXM_IP_PROTO = 201,
    OF_OXM_IP_PROTO_MASKED = 202,
    OF_OXM_IPV4_DST = 203,
    OF_OXM_IPV4_DST_MASKED = 204,
    OF_OXM_IPV4_SRC = 205,
    OF_OXM_IPV4_SRC_MASKED = 206,
    OF_OXM_IPV6_DST = 207,
    OF_OXM_IPV6_DST_MASKED = 208,
    OF_OXM_IPV6_FLABEL = 209,
    OF_OXM_IPV6_FLABEL_MASKED = 210,
    OF_OXM_IPV6_ND_SLL = 211,
    OF_OXM_IPV6_ND_SLL_MASKED = 212,
    OF_OXM_IPV6_ND_TARGET = 213,
    OF_OXM_IPV6_ND_TARGET_MASKED = 214,
    OF_OXM_IPV6_ND_TLL = 215,
    OF_OXM_IPV6_ND_TLL_MASKED = 216,
    OF_OXM_IPV6_SRC = 217,
    OF_OXM_IPV6_SRC_MASKED = 218,
    OF_OXM_METADATA = 219,
    OF_OXM_METADATA_MASKED = 220,
    OF_OXM_MPLS_LABEL = 221,
    OF_OXM_MPLS_LABEL_MASKED = 222,
    OF_OXM_MPLS_TC = 223,
    OF_OXM_MPLS_TC_MASKED = 224,
    OF_OXM_SCTP_DST = 225,
    OF_OXM_SCTP_DST_MASKED = 226,
    OF_OXM_SCTP_SRC = 227,
    OF_OXM_SCTP_SRC_MASKED = 228,
    OF_OXM_TCP_DST = 229,
    OF_OXM_TCP_DST_MASKED = 230,
    OF_OXM_TCP_SRC = 231,
    OF_OXM_TCP_SRC_MASKED = 232,
    OF_OXM_UDP_DST = 233,
    OF_OXM_UDP_DST_MASKED = 234,
    OF_OXM_UDP_SRC = 235,
    OF_OXM_UDP_SRC_MASKED = 236,
    OF_OXM_VLAN_PCP = 237,
    OF_OXM_VLAN_PCP_MASKED = 238,
    OF_OXM_VLAN_VID = 239,
    OF_OXM_VLAN_VID_MASKED = 240,
    OF_PACKET_QUEUE = 241,
    OF_PORT_DESC = 242,
    OF_PORT_STATS_ENTRY = 243,
    OF_QUEUE_PROP = 244,
    OF_QUEUE_PROP_EXPERIMENTER = 245,
    OF_QUEUE_PROP_HEADER = 246,
    OF_QUEUE_PROP_MAX_RATE = 247,
    OF_QUEUE_PROP_MIN_RATE = 248,
    OF_QUEUE_STATS_ENTRY = 249,
    OF_TABLE_FEATURE_PROP = 250,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 251,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 252,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 253,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 254,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 255,
    OF_TABLE_FEATURE_PROP_HEADER = 256,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 257,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 258,
    OF_TABLE_FEATURE_PROP_MATCH = 259,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 260,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 261,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 262,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 263,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 264,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 265,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 266,
    OF_TABLE_FEATURES = 267,
    OF_TABLE_STATS_ENTRY = 268,
    OF_UINT32 = 269,
    OF_UINT8 = 270,

    /* List objects */
    OF_LIST_ACTION = 271,
    OF_LIST_ACTION_ID = 272,
    OF_LIST_BSN_INTERFACE = 273,
    OF_LIST_BUCKET = 274,
    OF_LIST_BUCKET_COUNTER = 275,
    OF_LIST_FLOW_STATS_ENTRY = 276,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 277,
    OF_LIST_GROUP_STATS_ENTRY = 278,
    OF_LIST_HELLO_ELEM = 279,
    OF_LIST_INSTRUCTION = 280,
    OF_LIST_METER_BAND = 281,
    OF_LIST_METER_BAND_STATS = 282,
    OF_LIST_METER_STATS = 283,
    OF_LIST_OXM = 284,
    OF_LIST_PACKET_QUEUE = 285,
    OF_LIST_PORT_DESC = 286,
    OF_LIST_PORT_STATS_ENTRY = 287,
    OF_LIST_QUEUE_PROP = 288,
    OF_LIST_QUEUE_STATS_ENTRY = 289,
    OF_LIST_TABLE_FEATURE_PROP = 290,
    OF_LIST_TABLE_FEATURES = 291,
    OF_LIST_TABLE_STATS_ENTRY = 292,
    OF_LIST_UINT32 = 293,
    OF_LIST_UINT8 = 294,
...
#define OF_MESSAGE_OBJECT_COUNT 76
