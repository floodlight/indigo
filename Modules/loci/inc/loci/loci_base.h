...
typedef enum of_object_id_e {
    ...
    OF_ASYNC_SET = 5,
    OF_BARRIER_REPLY = 6,
    OF_BARRIER_REQUEST = 7,
    OF_BSN_BW_CLEAR_DATA_REPLY = 8,
    OF_BSN_BW_CLEAR_DATA_REQUEST = 9,
    OF_BSN_BW_ENABLE_GET_REPLY = 10,
    OF_BSN_BW_ENABLE_GET_REQUEST = 11,
    OF_BSN_BW_ENABLE_SET_REPLY = 12,
    OF_BSN_BW_ENABLE_SET_REQUEST = 13,
    OF_BSN_GET_INTERFACES_REPLY = 14,
    OF_BSN_GET_INTERFACES_REQUEST = 15,
    OF_BSN_GET_IP_MASK_REPLY = 16,
    OF_BSN_GET_IP_MASK_REQUEST = 17,
    OF_BSN_GET_L2_TABLE_REPLY = 18,
    OF_BSN_GET_L2_TABLE_REQUEST = 19,
    OF_BSN_GET_MIRRORING_REPLY = 20,
    OF_BSN_GET_MIRRORING_REQUEST = 21,
    OF_BSN_HEADER = 22,
    OF_BSN_HYBRID_GET_REPLY = 23,
    OF_BSN_HYBRID_GET_REQUEST = 24,
    OF_BSN_SET_IP_MASK = 25,
    OF_BSN_SET_L2_TABLE_REPLY = 26,
    OF_BSN_SET_L2_TABLE_REQUEST = 27,
    OF_BSN_SET_MIRRORING = 28,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 29,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 30,
    OF_BSN_SHELL_COMMAND = 31,
    OF_BSN_SHELL_OUTPUT = 32,
    OF_BSN_SHELL_STATUS = 33,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 34,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 35,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 36,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 37,
    OF_DESC_STATS_REPLY = 38,
    OF_DESC_STATS_REQUEST = 39,
    OF_ECHO_REPLY = 40,
    OF_ECHO_REQUEST = 41,
    OF_ERROR_MSG = 42,
    OF_EXPERIMENTER = 43,
    OF_EXPERIMENTER_STATS_REPLY = 44,
    OF_EXPERIMENTER_STATS_REQUEST = 45,
    OF_FEATURES_REPLY = 46,
    OF_FEATURES_REQUEST = 47,
    OF_FLOW_ADD = 48,
    OF_FLOW_DELETE = 49,
    OF_FLOW_DELETE_STRICT = 50,
    OF_FLOW_MOD = 51,
    OF_FLOW_MODIFY = 52,
    OF_FLOW_MODIFY_STRICT = 53,
    OF_FLOW_REMOVED = 54,
    OF_FLOW_STATS_REPLY = 55,
    OF_FLOW_STATS_REQUEST = 56,
    OF_GET_CONFIG_REPLY = 57,
    OF_GET_CONFIG_REQUEST = 58,
    OF_GROUP_DESC_STATS_REPLY = 59,
    OF_GROUP_DESC_STATS_REQUEST = 60,
    OF_GROUP_FEATURES_STATS_REPLY = 61,
    OF_GROUP_FEATURES_STATS_REQUEST = 62,
    OF_GROUP_MOD = 63,
    OF_GROUP_STATS_REPLY = 64,
    OF_GROUP_STATS_REQUEST = 65,
    OF_HELLO = 66,
    OF_METER_CONFIG_STATS_REPLY = 67,
    OF_METER_CONFIG_STATS_REQUEST = 68,
    OF_METER_FEATURES_STATS_REPLY = 69,
    OF_METER_FEATURES_STATS_REQUEST = 70,
    OF_METER_MOD = 71,
    OF_METER_STATS_REPLY = 72,
    OF_METER_STATS_REQUEST = 73,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 74,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 75,
    OF_NICIRA_HEADER = 76,
    OF_PACKET_IN = 77,
    OF_PACKET_OUT = 78,
    OF_PORT_DESC_STATS_REPLY = 79,
    OF_PORT_DESC_STATS_REQUEST = 80,
    OF_PORT_MOD = 81,
    OF_PORT_STATS_REPLY = 82,
    OF_PORT_STATS_REQUEST = 83,
    OF_PORT_STATUS = 84,
    OF_QUEUE_GET_CONFIG_REPLY = 85,
    OF_QUEUE_GET_CONFIG_REQUEST = 86,
    OF_QUEUE_STATS_REPLY = 87,
    OF_QUEUE_STATS_REQUEST = 88,
    OF_ROLE_REPLY = 89,
    OF_ROLE_REQUEST = 90,
    OF_SET_CONFIG = 91,
    OF_STATS_REPLY = 92,
    OF_STATS_REQUEST = 93,
    OF_TABLE_FEATURES_STATS_REPLY = 94,
    OF_TABLE_FEATURES_STATS_REQUEST = 95,
    OF_TABLE_MOD = 96,
    OF_TABLE_STATS_REPLY = 97,
    OF_TABLE_STATS_REQUEST = 98,

    /* Non-message objects */
    OF_ACTION = 99,
    OF_ACTION_BSN = 100,
    OF_ACTION_BSN_MIRROR = 101,
    OF_ACTION_BSN_SET_TUNNEL_DST = 102,
    OF_ACTION_COPY_TTL_IN = 103,
    OF_ACTION_COPY_TTL_OUT = 104,
    OF_ACTION_DEC_MPLS_TTL = 105,
    OF_ACTION_DEC_NW_TTL = 106,
    OF_ACTION_ENQUEUE = 107,
    OF_ACTION_EXPERIMENTER = 108,
    OF_ACTION_GROUP = 109,
    OF_ACTION_HEADER = 110,
    OF_ACTION_ID = 111,
    OF_ACTION_ID_BSN = 112,
    OF_ACTION_ID_BSN_MIRROR = 113,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 114,
    OF_ACTION_ID_COPY_TTL_IN = 115,
    OF_ACTION_ID_COPY_TTL_OUT = 116,
    OF_ACTION_ID_DEC_MPLS_TTL = 117,
    OF_ACTION_ID_DEC_NW_TTL = 118,
    OF_ACTION_ID_EXPERIMENTER = 119,
    OF_ACTION_ID_GROUP = 120,
    OF_ACTION_ID_HEADER = 121,
    OF_ACTION_ID_NICIRA = 122,
    OF_ACTION_ID_NICIRA_DEC_TTL = 123,
    OF_ACTION_ID_OUTPUT = 124,
    OF_ACTION_ID_POP_MPLS = 125,
    OF_ACTION_ID_POP_PBB = 126,
    OF_ACTION_ID_POP_VLAN = 127,
    OF_ACTION_ID_PUSH_MPLS = 128,
    OF_ACTION_ID_PUSH_PBB = 129,
    OF_ACTION_ID_PUSH_VLAN = 130,
    OF_ACTION_ID_SET_FIELD = 131,
    OF_ACTION_ID_SET_MPLS_TTL = 132,
    OF_ACTION_ID_SET_NW_TTL = 133,
    OF_ACTION_ID_SET_QUEUE = 134,
    OF_ACTION_NICIRA = 135,
    OF_ACTION_NICIRA_DEC_TTL = 136,
    OF_ACTION_OUTPUT = 137,
    OF_ACTION_POP_MPLS = 138,
    OF_ACTION_POP_PBB = 139,
    OF_ACTION_POP_VLAN = 140,
    OF_ACTION_PUSH_MPLS = 141,
    OF_ACTION_PUSH_PBB = 142,
    OF_ACTION_PUSH_VLAN = 143,
    OF_ACTION_SET_DL_DST = 144,
    OF_ACTION_SET_DL_SRC = 145,
    OF_ACTION_SET_FIELD = 146,
    OF_ACTION_SET_MPLS_LABEL = 147,
    OF_ACTION_SET_MPLS_TC = 148,
    OF_ACTION_SET_MPLS_TTL = 149,
    OF_ACTION_SET_NW_DST = 150,
    OF_ACTION_SET_NW_ECN = 151,
    OF_ACTION_SET_NW_SRC = 152,
    OF_ACTION_SET_NW_TOS = 153,
    OF_ACTION_SET_NW_TTL = 154,
    OF_ACTION_SET_QUEUE = 155,
    OF_ACTION_SET_TP_DST = 156,
    OF_ACTION_SET_TP_SRC = 157,
    OF_ACTION_SET_VLAN_PCP = 158,
    OF_ACTION_SET_VLAN_VID = 159,
    OF_ACTION_STRIP_VLAN = 160,
    OF_BSN_INTERFACE = 161,
    OF_BSN_VPORT = 162,
    OF_BSN_VPORT_HEADER = 163,
    OF_BSN_VPORT_Q_IN_Q = 164,
    OF_BUCKET = 165,
    OF_BUCKET_COUNTER = 166,
    OF_EXPERIMENTER_MULTIPART_HEADER = 167,
    OF_FLOW_STATS_ENTRY = 168,
    OF_GROUP_DESC_STATS_ENTRY = 169,
    OF_GROUP_STATS_ENTRY = 170,
    OF_HEADER = 171,
    OF_HELLO_ELEM = 172,
    OF_HELLO_ELEM_HEADER = 173,
    OF_HELLO_ELEM_VERSIONBITMAP = 174,
    OF_INSTRUCTION = 175,
    OF_INSTRUCTION_APPLY_ACTIONS = 176,
    OF_INSTRUCTION_CLEAR_ACTIONS = 177,
    OF_INSTRUCTION_EXPERIMENTER = 178,
    OF_INSTRUCTION_GOTO_TABLE = 179,
    OF_INSTRUCTION_HEADER = 180,
    OF_INSTRUCTION_METER = 181,
    OF_INSTRUCTION_WRITE_ACTIONS = 182,
    OF_INSTRUCTION_WRITE_METADATA = 183,
    OF_MATCH_V1 = 184,
    OF_MATCH_V2 = 185,
    OF_MATCH_V3 = 186,
    OF_METER_BAND = 187,
    OF_METER_BAND_DROP = 188,
    OF_METER_BAND_DSCP_REMARK = 189,
    OF_METER_BAND_EXPERIMENTER = 190,
    OF_METER_BAND_HEADER = 191,
    OF_METER_BAND_STATS = 192,
    OF_METER_CONFIG = 193,
    OF_METER_FEATURES = 194,
    OF_METER_STATS = 195,
    OF_OXM = 196,
    OF_OXM_ARP_OP = 197,
    OF_OXM_ARP_OP_MASKED = 198,
    OF_OXM_ARP_SHA = 199,
    OF_OXM_ARP_SHA_MASKED = 200,
    OF_OXM_ARP_SPA = 201,
    OF_OXM_ARP_SPA_MASKED = 202,
    OF_OXM_ARP_THA = 203,
    OF_OXM_ARP_THA_MASKED = 204,
    OF_OXM_ARP_TPA = 205,
    OF_OXM_ARP_TPA_MASKED = 206,
    OF_OXM_BSN_IN_PORTS_128 = 207,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 208,
    OF_OXM_ETH_DST = 209,
    OF_OXM_ETH_DST_MASKED = 210,
    OF_OXM_ETH_SRC = 211,
    OF_OXM_ETH_SRC_MASKED = 212,
    OF_OXM_ETH_TYPE = 213,
    OF_OXM_ETH_TYPE_MASKED = 214,
    OF_OXM_HEADER = 215,
    OF_OXM_ICMPV4_CODE = 216,
    OF_OXM_ICMPV4_CODE_MASKED = 217,
    OF_OXM_ICMPV4_TYPE = 218,
    OF_OXM_ICMPV4_TYPE_MASKED = 219,
    OF_OXM_ICMPV6_CODE = 220,
    OF_OXM_ICMPV6_CODE_MASKED = 221,
    OF_OXM_ICMPV6_TYPE = 222,
    OF_OXM_ICMPV6_TYPE_MASKED = 223,
    OF_OXM_IN_PHY_PORT = 224,
    OF_OXM_IN_PHY_PORT_MASKED = 225,
    OF_OXM_IN_PORT = 226,
    OF_OXM_IN_PORT_MASKED = 227,
    OF_OXM_IP_DSCP = 228,
    OF_OXM_IP_DSCP_MASKED = 229,
    OF_OXM_IP_ECN = 230,
    OF_OXM_IP_ECN_MASKED = 231,
    OF_OXM_IP_PROTO = 232,
    OF_OXM_IP_PROTO_MASKED = 233,
    OF_OXM_IPV4_DST = 234,
    OF_OXM_IPV4_DST_MASKED = 235,
    OF_OXM_IPV4_SRC = 236,
    OF_OXM_IPV4_SRC_MASKED = 237,
    OF_OXM_IPV6_DST = 238,
    OF_OXM_IPV6_DST_MASKED = 239,
    OF_OXM_IPV6_FLABEL = 240,
    OF_OXM_IPV6_FLABEL_MASKED = 241,
    OF_OXM_IPV6_ND_SLL = 242,
    OF_OXM_IPV6_ND_SLL_MASKED = 243,
    OF_OXM_IPV6_ND_TARGET = 244,
    OF_OXM_IPV6_ND_TARGET_MASKED = 245,
    OF_OXM_IPV6_ND_TLL = 246,
    OF_OXM_IPV6_ND_TLL_MASKED = 247,
    OF_OXM_IPV6_SRC = 248,
    OF_OXM_IPV6_SRC_MASKED = 249,
    OF_OXM_METADATA = 250,
    OF_OXM_METADATA_MASKED = 251,
    OF_OXM_MPLS_LABEL = 252,
    OF_OXM_MPLS_LABEL_MASKED = 253,
    OF_OXM_MPLS_TC = 254,
    OF_OXM_MPLS_TC_MASKED = 255,
    OF_OXM_SCTP_DST = 256,
    OF_OXM_SCTP_DST_MASKED = 257,
    OF_OXM_SCTP_SRC = 258,
    OF_OXM_SCTP_SRC_MASKED = 259,
    OF_OXM_TCP_DST = 260,
    OF_OXM_TCP_DST_MASKED = 261,
    OF_OXM_TCP_SRC = 262,
    OF_OXM_TCP_SRC_MASKED = 263,
    OF_OXM_UDP_DST = 264,
    OF_OXM_UDP_DST_MASKED = 265,
    OF_OXM_UDP_SRC = 266,
    OF_OXM_UDP_SRC_MASKED = 267,
    OF_OXM_VLAN_PCP = 268,
    OF_OXM_VLAN_PCP_MASKED = 269,
    OF_OXM_VLAN_VID = 270,
    OF_OXM_VLAN_VID_MASKED = 271,
    OF_PACKET_QUEUE = 272,
    OF_PORT_DESC = 273,
    OF_PORT_STATS_ENTRY = 274,
    OF_QUEUE_PROP = 275,
    OF_QUEUE_PROP_EXPERIMENTER = 276,
    OF_QUEUE_PROP_HEADER = 277,
    OF_QUEUE_PROP_MAX_RATE = 278,
    OF_QUEUE_PROP_MIN_RATE = 279,
    OF_QUEUE_STATS_ENTRY = 280,
    OF_TABLE_FEATURE_PROP = 281,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 282,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 283,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 284,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 285,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 286,
    OF_TABLE_FEATURE_PROP_HEADER = 287,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 288,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 289,
    OF_TABLE_FEATURE_PROP_MATCH = 290,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 291,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 292,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 293,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 294,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 295,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 296,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 297,
    OF_TABLE_FEATURES = 298,
    OF_TABLE_STATS_ENTRY = 299,
    OF_UINT32 = 300,
    OF_UINT8 = 301,

    /* List objects */
    OF_LIST_ACTION = 302,
    OF_LIST_ACTION_ID = 303,
    OF_LIST_BSN_INTERFACE = 304,
    OF_LIST_BUCKET = 305,
    OF_LIST_BUCKET_COUNTER = 306,
    OF_LIST_FLOW_STATS_ENTRY = 307,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 308,
    OF_LIST_GROUP_STATS_ENTRY = 309,
    OF_LIST_HELLO_ELEM = 310,
    OF_LIST_INSTRUCTION = 311,
    OF_LIST_METER_BAND = 312,
    OF_LIST_METER_BAND_STATS = 313,
    OF_LIST_METER_STATS = 314,
    OF_LIST_OXM = 315,
    OF_LIST_PACKET_QUEUE = 316,
    OF_LIST_PORT_DESC = 317,
    OF_LIST_PORT_STATS_ENTRY = 318,
    OF_LIST_QUEUE_PROP = 319,
    OF_LIST_QUEUE_STATS_ENTRY = 320,
    OF_LIST_TABLE_FEATURE_PROP = 321,
    OF_LIST_TABLE_FEATURES = 322,
    OF_LIST_TABLE_STATS_ENTRY = 323,
    OF_LIST_UINT32 = 324,
    OF_LIST_UINT8 = 325,
...
#define OF_MESSAGE_OBJECT_COUNT 99
