...
int
of_bsn_set_pktin_suppression_OF_VERSION_1_0_dump(loci_writer_f writer, void* cookie, of_bsn_set_pktin_suppression_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;
    ...
    out += writer(cookie, "Object of type of_bsn_set_pktin_suppression\n");
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_0_dump(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;

    out += writer(cookie, "Object of type of_bsn_virtual_port_remove\n");

    of_bsn_virtual_port_remove_xid_get(obj, &val32);
    out += writer(cookie, "  xid (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_bsn_virtual_port_remove_experimenter_get(obj, &val32);
    out += writer(cookie, "  experimenter (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_bsn_virtual_port_remove_subtype_get(obj, &val32);
    out += writer(cookie, "  subtype (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_bsn_virtual_port_remove_vport_no_get(obj, &val32);
    out += writer(cookie, "  vport_no (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
of_error_msg_OF_VERSION_1_0_dump(loci_writer_f writer, void* cookie, of_error_msg_t *obj)
{
    ...
    out += writer(cookie, "  err_type (uint16_t):  ");
    out += LOCI_DUMP_u16(writer, cookie, val16);
    out += writer(cookie, "\n");
...
of_bsn_interface_OF_VERSION_1_0_dump(loci_writer_f writer, void* cookie, of_bsn_interface_t *obj)
{
    ...
    of_bsn_interface_ipv4_addr_get(obj, &val32);
    out += writer(cookie, "  ipv4_addr (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_bsn_interface_ipv4_netmask_get(obj, &val32);
    out += writer(cookie, "  ipv4_netmask (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
of_match_v1_OF_VERSION_1_0_dump(loci_writer_f writer, void* cookie, of_match_v1_t *obj)
{
    ...
    of_match_v1_ipv4_dst_get(obj, &val32);
    out += writer(cookie, "  ipv4_dst (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
int
of_bsn_set_pktin_suppression_OF_VERSION_1_1_dump(loci_writer_f writer, void* cookie, of_bsn_set_pktin_suppression_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_1_dump(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
of_match_v2_OF_VERSION_1_1_dump(loci_writer_f writer, void* cookie, of_match_v2_t *obj)
{
    ...
    of_match_v2_ipv4_src_get(obj, &val32);
    out += writer(cookie, "  ipv4_src (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_match_v2_ipv4_src_mask_get(obj, &val32);
    out += writer(cookie, "  ipv4_src_mask (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_match_v2_ipv4_dst_get(obj, &val32);
    out += writer(cookie, "  ipv4_dst (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_match_v2_ipv4_dst_mask_get(obj, &val32);
    out += writer(cookie, "  ipv4_dst_mask (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
int
of_bsn_set_pktin_suppression_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_bsn_set_pktin_suppression_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
of_role_reply_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_role_reply_t *obj)
{
    ...
    of_role_reply_data_get(obj, &octets);
    out += writer(cookie, "  data (of_octets_t):  ");
    out += LOCI_DUMP_octets(writer, cookie, octets);
    out += writer(cookie, "\n");
...
of_oxm_ipv4_dst_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_oxm_ipv4_dst_t *obj)
{
    ...
    of_oxm_ipv4_dst_value_get(obj, &val32);
    out += writer(cookie, "  value (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
of_oxm_ipv4_dst_masked_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_oxm_ipv4_dst_masked_t *obj)
{
    ...
    of_oxm_ipv4_dst_masked_value_get(obj, &val32);
    out += writer(cookie, "  value (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_oxm_ipv4_dst_masked_value_mask_get(obj, &val32);
    out += writer(cookie, "  value_mask (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
of_oxm_ipv4_src_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_oxm_ipv4_src_t *obj)
{
    ...
    of_oxm_ipv4_src_value_get(obj, &val32);
    out += writer(cookie, "  value (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
of_oxm_ipv4_src_masked_OF_VERSION_1_2_dump(loci_writer_f writer, void* cookie, of_oxm_ipv4_src_masked_t *obj)
{
    ...
    of_oxm_ipv4_src_masked_value_get(obj, &val32);
    out += writer(cookie, "  value (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");

    of_oxm_ipv4_src_masked_value_mask_get(obj, &val32);
    out += writer(cookie, "  value_mask (uint32_t):  ");
    out += LOCI_DUMP_u32(writer, cookie, val32);
    out += writer(cookie, "\n");
...
int
of_bsn_set_pktin_suppression_OF_VERSION_1_3_dump(loci_writer_f writer, void* cookie, of_bsn_set_pktin_suppression_t *obj)
{
    int out = 0;
    uint32_t val32;
    uint8_t val8;
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_3_dump(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
int
of_experimenter_multipart_header_OF_VERSION_1_3_dump(loci_writer_f writer, void* cookie, of_experimenter_multipart_header_t *obj)
{
    int out = 0;
    uint32_t val32;

    out += writer(cookie, "Object of type of_experimenter_multipart_header\n");
...
loci_dump_match(loci_writer_f writer, void* cookie, of_match_t *match)
{
    ...
    if (OF_MATCH_MASK_IPV4_SRC_ACTIVE_TEST(match)) {
        out += writer(cookie, "  ipv4_src (uint32_t) active: Value ");
        out += LOCI_DUMP_u32(writer, cookie, match->fields.ipv4_src);
        out += writer(cookie, "\n    Mask ");
        out += LOCI_DUMP_u32(writer, cookie, match->masks.ipv4_src);
        out += writer(cookie, "\n");
    }
    ...
    if (OF_MATCH_MASK_IPV4_DST_ACTIVE_TEST(match)) {
        out += writer(cookie, "  ipv4_dst (uint32_t) active: Value ");
        out += LOCI_DUMP_u32(writer, cookie, match->fields.ipv4_dst);
        out += writer(cookie, "\n    Mask ");
        out += LOCI_DUMP_u32(writer, cookie, match->masks.ipv4_dst);
        out += writer(cookie, "\n");
    }
...
static const loci_obj_dump_f dump_funs_v1[OF_OBJECT_COUNT] = {
    ...
    of_bsn_set_pktin_suppression_OF_VERSION_1_0_dump,
    ...
    of_bsn_virtual_port_remove_OF_VERSION_1_0_dump,
...
static const loci_obj_dump_f dump_funs_v4[OF_OBJECT_COUNT] = {
    ...
    of_experimenter_multipart_header_OF_VERSION_1_3_dump,
