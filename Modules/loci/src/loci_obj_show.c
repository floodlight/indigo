...
int
of_bsn_virtual_port_remove_OF_VERSION_1_0_show(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
of_bsn_interface_OF_VERSION_1_0_show(loci_writer_f writer, void* cookie, of_bsn_interface_t *obj)
{
    ...
    out += LOCI_SHOW_u32_ipv4_addr(writer, cookie, val32);
    out += writer(cookie, " ");

    of_bsn_interface_ipv4_netmask_get(obj, &val32);
    out += writer(cookie, "ipv4_netmask=");
    out += LOCI_SHOW_u32_ipv4_netmask(writer, cookie, val32);
    out += writer(cookie, " ");
...
of_match_v1_OF_VERSION_1_0_show(loci_writer_f writer, void* cookie, of_match_v1_t *obj)
{
    ...
    out += LOCI_SHOW_u32_ipv4_dst(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_1_show(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
of_match_v2_OF_VERSION_1_1_show(loci_writer_f writer, void* cookie, of_match_v2_t *obj)
{
    ...
    out += LOCI_SHOW_u32_ipv4_src_mask(writer, cookie, val32);
    out += writer(cookie, " ");
    ...
    out += LOCI_SHOW_u32_ipv4_dst_mask(writer, cookie, val32);
    out += writer(cookie, " ");
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_2_show(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
int
of_bsn_virtual_port_remove_OF_VERSION_1_3_show(loci_writer_f writer, void* cookie, of_bsn_virtual_port_remove_t *obj)
{
    int out = 0;
    uint32_t val32;
...
loci_show_match(loci_writer_f writer, void* cookie, of_match_t *match)
{
    ...
    if (OF_MATCH_MASK_IPV4_SRC_ACTIVE_TEST(match)) {
        ...
        out += LOCI_SHOW_u32_ipv4_src(writer, cookie, match->fields.ipv4_src);
        out += writer(cookie, "/");
        out += LOCI_SHOW_u32_ipv4_src(writer, cookie, match->masks.ipv4_src);
        out += writer(cookie, " ");
    }
    ...
    if (OF_MATCH_MASK_IPV4_DST_ACTIVE_TEST(match)) {
        ...
        out += LOCI_SHOW_u32_ipv4_dst(writer, cookie, match->fields.ipv4_dst);
        out += writer(cookie, "/");
        out += LOCI_SHOW_u32_ipv4_dst(writer, cookie, match->masks.ipv4_dst);
        out += writer(cookie, " ");
    }
...
static const loci_obj_show_f show_funs_v1[OF_OBJECT_COUNT] = {
    ...
    of_bsn_virtual_port_remove_OF_VERSION_1_0_show,
...
static const loci_obj_show_f show_funs_v2[OF_OBJECT_COUNT] = {
    ...
    of_bsn_virtual_port_remove_OF_VERSION_1_1_show,
...
static const loci_obj_show_f show_funs_v3[OF_OBJECT_COUNT] = {
    ...
    of_bsn_virtual_port_remove_OF_VERSION_1_2_show,
...
static const loci_obj_show_f show_funs_v4[OF_OBJECT_COUNT] = {
    ...
    of_bsn_virtual_port_remove_OF_VERSION_1_3_show,
