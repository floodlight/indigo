...
static int
test_of_bsn_set_l2_table_create_OF_VERSION_1_0(void)
{
    ...
    /* Set up incrementing values for scalar members */
    value = of_bsn_set_l2_table_OF_VERSION_1_0_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    /* TODO:  */
    TEST_ASSERT(of_message_to_object_id(msg_buf, len) == OF_BSN_SET_L2_TABLE);
    obj = of_bsn_set_l2_table_new_from_message(OF_BUFFER_TO_MESSAGE(msg_buf));

    TEST_ASSERT(obj != NULL);

    /* @fixme Set up all message objects (recursively?) */

    value = of_bsn_set_l2_table_OF_VERSION_1_0_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_error_msg_create_OF_VERSION_1_0(void)
{
    of_error_msg_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_error_msg_OF_VERSION_1_0_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    /* TODO:  */
    TEST_ASSERT(of_message_to_object_id(msg_buf, len) == OF_ERROR_MSG);
    obj = of_error_msg_new_from_message(OF_BUFFER_TO_MESSAGE(msg_buf));

    TEST_ASSERT(obj != NULL);

    /* @fixme Set up all message objects (recursively?) */

    value = of_error_msg_OF_VERSION_1_0_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_create_OF_VERSION_1_0(void)
{
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_OF_VERSION_1_0_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    /* TODO:  */
    TEST_ASSERT(of_message_to_object_id(msg_buf, len) == OF_EXPERIMENTER);
    obj = of_experimenter_new_from_message(OF_BUFFER_TO_MESSAGE(msg_buf));

    TEST_ASSERT(obj != NULL);

    /* @fixme Set up all message objects (recursively?) */

    value = of_experimenter_OF_VERSION_1_0_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_reply_create_OF_VERSION_1_0(void)
{
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_reply_OF_VERSION_1_0_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    /* TODO:  */
    TEST_ASSERT(of_message_to_object_id(msg_buf, len) == OF_EXPERIMENTER_STATS_REPLY);
    obj = of_experimenter_stats_reply_new_from_message(OF_BUFFER_TO_MESSAGE(msg_buf));

    TEST_ASSERT(obj != NULL);

    /* @fixme Set up all message objects (recursively?) */

    value = of_experimenter_stats_reply_OF_VERSION_1_0_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_request_create_OF_VERSION_1_0(void)
{
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_request_OF_VERSION_1_0_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    /* TODO:  */
    TEST_ASSERT(of_message_to_object_id(msg_buf, len) == OF_EXPERIMENTER_STATS_REQUEST);
    obj = of_experimenter_stats_request_new_from_message(OF_BUFFER_TO_MESSAGE(msg_buf));

    TEST_ASSERT(obj != NULL);

    /* @fixme Set up all message objects (recursively?) */

    value = of_experimenter_stats_request_OF_VERSION_1_0_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_error_msg_create_OF_VERSION_1_1(void)
{
    of_error_msg_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_error_msg_OF_VERSION_1_1_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_error_msg_OF_VERSION_1_1_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_create_OF_VERSION_1_1(void)
{
    of_experimenter_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_OF_VERSION_1_1_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_OF_VERSION_1_1_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_reply_create_OF_VERSION_1_1(void)
{
    of_experimenter_stats_reply_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_reply_OF_VERSION_1_1_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_stats_reply_OF_VERSION_1_1_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_request_create_OF_VERSION_1_1(void)
{
    of_experimenter_stats_request_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_request_OF_VERSION_1_1_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_stats_request_OF_VERSION_1_1_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_error_msg_create_OF_VERSION_1_2(void)
{
    of_error_msg_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_error_msg_OF_VERSION_1_2_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_error_msg_OF_VERSION_1_2_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_create_OF_VERSION_1_2(void)
{
    of_experimenter_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_OF_VERSION_1_2_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_OF_VERSION_1_2_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_reply_create_OF_VERSION_1_2(void)
{
    of_experimenter_stats_reply_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_reply_OF_VERSION_1_2_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_stats_reply_OF_VERSION_1_2_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_stats_request_create_OF_VERSION_1_2(void)
{
    of_experimenter_stats_request_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_stats_request_OF_VERSION_1_2_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_stats_request_OF_VERSION_1_2_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_error_msg_create_OF_VERSION_1_3(void)
{
    of_error_msg_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_error_msg_OF_VERSION_1_3_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_error_msg_OF_VERSION_1_3_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
static int
test_of_experimenter_create_OF_VERSION_1_3(void)
{
    of_experimenter_t *obj;
    uint8_t *msg_buf;
    int value;
    ...
    /* Set up incrementing values for scalar members */
    value = of_experimenter_OF_VERSION_1_3_populate_scalars(obj, 1);
    TEST_ASSERT(value != 0);
    ...
    value = of_experimenter_OF_VERSION_1_3_check_scalars(obj, 1);
    TEST_ASSERT(value != 0);
...
run_message_tests(void)
{
    ...
    RUN_TEST(of_bsn_set_l2_table_create_OF_VERSION_1_0);
    ...
    RUN_TEST(of_error_msg_create_OF_VERSION_1_0);
    RUN_TEST(of_experimenter_create_OF_VERSION_1_0);
    RUN_TEST(of_experimenter_stats_reply_create_OF_VERSION_1_0);
    RUN_TEST(of_experimenter_stats_request_create_OF_VERSION_1_0);
    ...
    RUN_TEST(of_error_msg_create_OF_VERSION_1_1);
    RUN_TEST(of_experimenter_create_OF_VERSION_1_1);
    RUN_TEST(of_experimenter_stats_reply_create_OF_VERSION_1_1);
    RUN_TEST(of_experimenter_stats_request_create_OF_VERSION_1_1);
    ...
    RUN_TEST(of_error_msg_create_OF_VERSION_1_2);
    RUN_TEST(of_experimenter_create_OF_VERSION_1_2);
    RUN_TEST(of_experimenter_stats_reply_create_OF_VERSION_1_2);
    RUN_TEST(of_experimenter_stats_request_create_OF_VERSION_1_2);
    ...
    RUN_TEST(of_error_msg_create_OF_VERSION_1_3);
    RUN_TEST(of_experimenter_create_OF_VERSION_1_3);
