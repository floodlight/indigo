...
static int
test_of_oxm_experimenter_header_OF_VERSION_1_2(void)
{
...
static int
test_of_oxm_experimenter_header_OF_VERSION_1_3(void)
{
    of_oxm_experimenter_header_t *obj;
...
run_unified_accessor_tests(void)
{
    ...
    RUN_TEST(of_oxm_experimenter_header_OF_VERSION_1_2);
    ...
    RUN_TEST(of_oxm_experimenter_header_OF_VERSION_1_3);
