...
/**
 * OFCONNECTIONMANAGER_CONFIG_OVERRIDE_TLS_CIPHER_LIST
 *
 * Override TLS cipher list config file setting */


#ifndef OFCONNECTIONMANAGER_CONFIG_OVERRIDE_TLS_CIPHER_LIST
#define OFCONNECTIONMANAGER_CONFIG_OVERRIDE_TLS_CIPHER_LIST 0
#endif

/**
 * OFCONNECTIONMANAGER_CONFIG_TLS_CIPHER_LIST
 *
 * TLS cipher list if config file setting is overridden */


#ifndef OFCONNECTIONMANAGER_CONFIG_TLS_CIPHER_LIST
#define OFCONNECTIONMANAGER_CONFIG_TLS_CIPHER_LIST "HIGH"
#endif
