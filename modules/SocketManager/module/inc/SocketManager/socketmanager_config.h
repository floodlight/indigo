...
#define SOCKETMANAGER_CONFIG_MAX_TIMERS 64
#endif

/**
 * SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS
 *
 * Granularity of the timer wheel (milliseconds) */


#ifndef SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS
#define SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS 128
#endif

/**
 * SOCKETMANAGER_CONFIG_TIMER_PEEK_MS
 *
 * Milliseconds to look ahead for the next timer */


#ifndef SOCKETMANAGER_CONFIG_TIMER_PEEK_MS
