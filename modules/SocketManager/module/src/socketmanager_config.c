...
#endif
#ifdef SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS
    { __socketmanager_config_STRINGIFY_NAME(SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS), __socketmanager_config_STRINGIFY_VALUE(SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS) },
#else
{ SOCKETMANAGER_CONFIG_TIMER_GRANULARITY_MS(__socketmanager_config_STRINGIFY_NAME), "__undefined__" },
#endif
#ifdef SOCKETMANAGER_CONFIG_TIMER_PEEK_MS
    { __socketmanager_config_STRINGIFY_NAME(SOCKETMANAGER_CONFIG_TIMER_PEEK_MS), __socketmanager_config_STRINGIFY_VALUE(SOCKETMANAGER_CONFIG_TIMER_PEEK_MS) },
#else
