...
typedef enum of_object_id_e {
    ...
    OF_OXM_ETH_DST = 207,
    OF_OXM_ETH_DST_MASKED = 208,
    OF_OXM_ETH_SRC = 209,
    OF_OXM_ETH_SRC_MASKED = 210,
    OF_OXM_ETH_TYPE = 211,
    OF_OXM_ETH_TYPE_MASKED = 212,
    OF_OXM_HEADER = 213,
    OF_OXM_ICMPV4_CODE = 214,
    OF_OXM_ICMPV4_CODE_MASKED = 215,
    OF_OXM_ICMPV4_TYPE = 216,
    OF_OXM_ICMPV4_TYPE_MASKED = 217,
    OF_OXM_ICMPV6_CODE = 218,
    OF_OXM_ICMPV6_CODE_MASKED = 219,
    OF_OXM_ICMPV6_TYPE = 220,
    OF_OXM_ICMPV6_TYPE_MASKED = 221,
    OF_OXM_IN_PHY_PORT = 222,
    OF_OXM_IN_PHY_PORT_MASKED = 223,
    OF_OXM_IN_PORT = 224,
    OF_OXM_IN_PORT_MASKED = 225,
    OF_OXM_IP_DSCP = 226,
    OF_OXM_IP_DSCP_MASKED = 227,
    OF_OXM_IP_ECN = 228,
    OF_OXM_IP_ECN_MASKED = 229,
    OF_OXM_IP_PROTO = 230,
    OF_OXM_IP_PROTO_MASKED = 231,
    OF_OXM_IPV4_DST = 232,
    OF_OXM_IPV4_DST_MASKED = 233,
    OF_OXM_IPV4_SRC = 234,
    OF_OXM_IPV4_SRC_MASKED = 235,
    OF_OXM_IPV6_DST = 236,
    OF_OXM_IPV6_DST_MASKED = 237,
    OF_OXM_IPV6_FLABEL = 238,
    OF_OXM_IPV6_FLABEL_MASKED = 239,
    OF_OXM_IPV6_ND_SLL = 240,
    OF_OXM_IPV6_ND_SLL_MASKED = 241,
    OF_OXM_IPV6_ND_TARGET = 242,
    OF_OXM_IPV6_ND_TARGET_MASKED = 243,
    OF_OXM_IPV6_ND_TLL = 244,
    OF_OXM_IPV6_ND_TLL_MASKED = 245,
    OF_OXM_IPV6_SRC = 246,
    OF_OXM_IPV6_SRC_MASKED = 247,
    OF_OXM_METADATA = 248,
    OF_OXM_METADATA_MASKED = 249,
    OF_OXM_MPLS_LABEL = 250,
    OF_OXM_MPLS_LABEL_MASKED = 251,
    OF_OXM_MPLS_TC = 252,
    OF_OXM_MPLS_TC_MASKED = 253,
    OF_OXM_SCTP_DST = 254,
    OF_OXM_SCTP_DST_MASKED = 255,
    OF_OXM_SCTP_SRC = 256,
    OF_OXM_SCTP_SRC_MASKED = 257,
    OF_OXM_TCP_DST = 258,
    OF_OXM_TCP_DST_MASKED = 259,
    OF_OXM_TCP_SRC = 260,
    OF_OXM_TCP_SRC_MASKED = 261,
    OF_OXM_UDP_DST = 262,
    OF_OXM_UDP_DST_MASKED = 263,
    OF_OXM_UDP_SRC = 264,
    OF_OXM_UDP_SRC_MASKED = 265,
    OF_OXM_VLAN_PCP = 266,
    OF_OXM_VLAN_PCP_MASKED = 267,
    OF_OXM_VLAN_VID = 268,
    OF_OXM_VLAN_VID_MASKED = 269,
    OF_PACKET_QUEUE = 270,
    OF_PORT_DESC = 271,
    OF_PORT_STATS_ENTRY = 272,
    OF_QUEUE_PROP = 273,
    OF_QUEUE_PROP_EXPERIMENTER = 274,
    OF_QUEUE_PROP_HEADER = 275,
    OF_QUEUE_PROP_MAX_RATE = 276,
    OF_QUEUE_PROP_MIN_RATE = 277,
    OF_QUEUE_STATS_ENTRY = 278,
    OF_TABLE_FEATURE_PROP = 279,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 280,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 281,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 282,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 283,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 284,
    OF_TABLE_FEATURE_PROP_HEADER = 285,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 286,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 287,
    OF_TABLE_FEATURE_PROP_MATCH = 288,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 289,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 290,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 291,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 292,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 293,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 294,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 295,
    OF_TABLE_FEATURES = 296,
    OF_TABLE_STATS_ENTRY = 297,
    OF_UINT32 = 298,
    OF_UINT8 = 299,

    /* List objects */
    OF_LIST_ACTION = 300,
    OF_LIST_ACTION_ID = 301,
    OF_LIST_BSN_INTERFACE = 302,
    OF_LIST_BUCKET = 303,
    OF_LIST_BUCKET_COUNTER = 304,
    OF_LIST_FLOW_STATS_ENTRY = 305,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 306,
    OF_LIST_GROUP_STATS_ENTRY = 307,
    OF_LIST_HELLO_ELEM = 308,
    OF_LIST_INSTRUCTION = 309,
    OF_LIST_METER_BAND = 310,
    OF_LIST_METER_BAND_STATS = 311,
    OF_LIST_METER_STATS = 312,
    OF_LIST_OXM = 313,
    OF_LIST_PACKET_QUEUE = 314,
    OF_LIST_PORT_DESC = 315,
    OF_LIST_PORT_STATS_ENTRY = 316,
    OF_LIST_QUEUE_PROP = 317,
    OF_LIST_QUEUE_STATS_ENTRY = 318,
    OF_LIST_TABLE_FEATURE_PROP = 319,
    OF_LIST_TABLE_FEATURES = 320,
    OF_LIST_TABLE_STATS_ENTRY = 321,
    OF_LIST_UINT32 = 322,
    OF_LIST_UINT8 = 323,
