...
typedef enum of_object_id_e {
    ...
    OF_BSN_GET_INTERFACES_REPLY = 8,
    OF_BSN_GET_INTERFACES_REQUEST = 9,
    OF_BSN_GET_IP_MASK_REPLY = 10,
    OF_BSN_GET_IP_MASK_REQUEST = 11,
    OF_BSN_GET_L2_TABLE_REPLY = 12,
    OF_BSN_GET_L2_TABLE_REQUEST = 13,
    OF_BSN_GET_MIRRORING_REPLY = 14,
    OF_BSN_GET_MIRRORING_REQUEST = 15,
    OF_BSN_SET_IP_MASK = 16,
    OF_BSN_SET_L2_TABLE = 17,
    OF_BSN_SET_MIRRORING = 18,
    OF_BSN_SET_PKTIN_SUPPRESSION = 19,
    OF_BSN_SHELL_COMMAND = 20,
    OF_BSN_SHELL_OUTPUT = 21,
    OF_BSN_SHELL_STATUS = 22,
    OF_DESC_STATS_REPLY = 23,
    OF_DESC_STATS_REQUEST = 24,
    OF_ECHO_REPLY = 25,
    OF_ECHO_REQUEST = 26,
    OF_ERROR_MSG = 27,
    OF_EXPERIMENTER = 28,
    OF_EXPERIMENTER_STATS_REPLY = 29,
    OF_EXPERIMENTER_STATS_REQUEST = 30,
    OF_FEATURES_REPLY = 31,
    OF_FEATURES_REQUEST = 32,
    OF_FLOW_ADD = 33,
    OF_FLOW_DELETE = 34,
    OF_FLOW_DELETE_STRICT = 35,
    OF_FLOW_MODIFY = 36,
    OF_FLOW_MODIFY_STRICT = 37,
    OF_FLOW_REMOVED = 38,
    OF_FLOW_STATS_REPLY = 39,
    OF_FLOW_STATS_REQUEST = 40,
    OF_GET_CONFIG_REPLY = 41,
    OF_GET_CONFIG_REQUEST = 42,
    OF_GROUP_DESC_STATS_REPLY = 43,
    OF_GROUP_DESC_STATS_REQUEST = 44,
    OF_GROUP_FEATURES_STATS_REPLY = 45,
    OF_GROUP_FEATURES_STATS_REQUEST = 46,
    OF_GROUP_MOD = 47,
    OF_GROUP_STATS_REPLY = 48,
    OF_GROUP_STATS_REQUEST = 49,
    OF_HELLO = 50,
    OF_METER_CONFIG_STATS_REPLY = 51,
    OF_METER_CONFIG_STATS_REQUEST = 52,
    OF_METER_FEATURES_STATS_REPLY = 53,
    OF_METER_FEATURES_STATS_REQUEST = 54,
    OF_METER_MOD = 55,
    OF_METER_STATS_REPLY = 56,
    OF_METER_STATS_REQUEST = 57,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 58,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 59,
    OF_PACKET_IN = 60,
    OF_PACKET_OUT = 61,
    OF_PORT_DESC_STATS_REPLY = 62,
    OF_PORT_DESC_STATS_REQUEST = 63,
    OF_PORT_MOD = 64,
    OF_PORT_STATS_REPLY = 65,
    OF_PORT_STATS_REQUEST = 66,
    OF_PORT_STATUS = 67,
    OF_QUEUE_GET_CONFIG_REPLY = 68,
    OF_QUEUE_GET_CONFIG_REQUEST = 69,
    OF_QUEUE_STATS_REPLY = 70,
    OF_QUEUE_STATS_REQUEST = 71,
    OF_ROLE_REPLY = 72,
    OF_ROLE_REQUEST = 73,
    OF_SET_CONFIG = 74,
    OF_TABLE_FEATURES_STATS_REPLY = 75,
    OF_TABLE_FEATURES_STATS_REQUEST = 76,
    OF_TABLE_MOD = 77,
    OF_TABLE_STATS_REPLY = 78,
    OF_TABLE_STATS_REQUEST = 79,

    /* Non-message objects */
    OF_ACTION = 80,
    OF_ACTION_BSN_MIRROR = 81,
    OF_ACTION_BSN_SET_TUNNEL_DST = 82,
    OF_ACTION_COPY_TTL_IN = 83,
    OF_ACTION_COPY_TTL_OUT = 84,
    OF_ACTION_DEC_MPLS_TTL = 85,
    OF_ACTION_DEC_NW_TTL = 86,
    OF_ACTION_ENQUEUE = 87,
    OF_ACTION_EXPERIMENTER = 88,
    OF_ACTION_GROUP = 89,
    OF_ACTION_HEADER = 90,
    OF_ACTION_ID = 91,
    OF_ACTION_ID_BSN_MIRROR = 92,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 93,
    OF_ACTION_ID_COPY_TTL_IN = 94,
    OF_ACTION_ID_COPY_TTL_OUT = 95,
    OF_ACTION_ID_DEC_MPLS_TTL = 96,
    OF_ACTION_ID_DEC_NW_TTL = 97,
    OF_ACTION_ID_EXPERIMENTER = 98,
    OF_ACTION_ID_GROUP = 99,
    OF_ACTION_ID_HEADER = 100,
    OF_ACTION_ID_NICIRA_DEC_TTL = 101,
    OF_ACTION_ID_OUTPUT = 102,
    OF_ACTION_ID_POP_MPLS = 103,
    OF_ACTION_ID_POP_PBB = 104,
    OF_ACTION_ID_POP_VLAN = 105,
    OF_ACTION_ID_PUSH_MPLS = 106,
    OF_ACTION_ID_PUSH_PBB = 107,
    OF_ACTION_ID_PUSH_VLAN = 108,
    OF_ACTION_ID_SET_FIELD = 109,
    OF_ACTION_ID_SET_MPLS_TTL = 110,
    OF_ACTION_ID_SET_NW_TTL = 111,
    OF_ACTION_ID_SET_QUEUE = 112,
    OF_ACTION_NICIRA_DEC_TTL = 113,
    OF_ACTION_OUTPUT = 114,
    OF_ACTION_POP_MPLS = 115,
    OF_ACTION_POP_PBB = 116,
    OF_ACTION_POP_VLAN = 117,
    OF_ACTION_PUSH_MPLS = 118,
    OF_ACTION_PUSH_PBB = 119,
    OF_ACTION_PUSH_VLAN = 120,
    OF_ACTION_SET_DL_DST = 121,
    OF_ACTION_SET_DL_SRC = 122,
    OF_ACTION_SET_FIELD = 123,
    OF_ACTION_SET_MPLS_LABEL = 124,
    OF_ACTION_SET_MPLS_TC = 125,
    OF_ACTION_SET_MPLS_TTL = 126,
    OF_ACTION_SET_NW_DST = 127,
    OF_ACTION_SET_NW_ECN = 128,
    OF_ACTION_SET_NW_SRC = 129,
    OF_ACTION_SET_NW_TOS = 130,
    OF_ACTION_SET_NW_TTL = 131,
    OF_ACTION_SET_QUEUE = 132,
    OF_ACTION_SET_TP_DST = 133,
    OF_ACTION_SET_TP_SRC = 134,
    OF_ACTION_SET_VLAN_PCP = 135,
    OF_ACTION_SET_VLAN_VID = 136,
    OF_ACTION_STRIP_VLAN = 137,
    OF_BSN_INTERFACE = 138,
    OF_BUCKET = 139,
    OF_BUCKET_COUNTER = 140,
    OF_EXPERIMENTER_MULTIPART_HEADER = 141,
    OF_FLOW_STATS_ENTRY = 142,
    OF_GROUP_DESC_STATS_ENTRY = 143,
    OF_GROUP_STATS_ENTRY = 144,
    OF_HEADER = 145,
    OF_HELLO_ELEM = 146,
    OF_HELLO_ELEM_HEADER = 147,
    OF_HELLO_ELEM_VERSIONBITMAP = 148,
    OF_INSTRUCTION = 149,
    OF_INSTRUCTION_APPLY_ACTIONS = 150,
    OF_INSTRUCTION_CLEAR_ACTIONS = 151,
    OF_INSTRUCTION_EXPERIMENTER = 152,
    OF_INSTRUCTION_GOTO_TABLE = 153,
    OF_INSTRUCTION_HEADER = 154,
    OF_INSTRUCTION_METER = 155,
    OF_INSTRUCTION_WRITE_ACTIONS = 156,
    OF_INSTRUCTION_WRITE_METADATA = 157,
    OF_MATCH_V1 = 158,
    OF_MATCH_V2 = 159,
    OF_MATCH_V3 = 160,
    OF_METER_BAND = 161,
    OF_METER_BAND_DROP = 162,
    OF_METER_BAND_DSCP_REMARK = 163,
    OF_METER_BAND_EXPERIMENTER = 164,
    OF_METER_BAND_HEADER = 165,
    OF_METER_BAND_STATS = 166,
    OF_METER_CONFIG = 167,
    OF_METER_FEATURES = 168,
    OF_METER_STATS = 169,
    OF_OXM = 170,
    OF_OXM_ARP_OP = 171,
    OF_OXM_ARP_OP_MASKED = 172,
    OF_OXM_ARP_SHA = 173,
    OF_OXM_ARP_SHA_MASKED = 174,
    OF_OXM_ARP_SPA = 175,
    OF_OXM_ARP_SPA_MASKED = 176,
    OF_OXM_ARP_THA = 177,
    OF_OXM_ARP_THA_MASKED = 178,
    OF_OXM_ARP_TPA = 179,
    OF_OXM_ARP_TPA_MASKED = 180,
    OF_OXM_ETH_DST = 181,
    OF_OXM_ETH_DST_MASKED = 182,
    OF_OXM_ETH_SRC = 183,
    OF_OXM_ETH_SRC_MASKED = 184,
    OF_OXM_ETH_TYPE = 185,
    OF_OXM_ETH_TYPE_MASKED = 186,
    OF_OXM_EXPERIMENTER_HEADER = 187,
    OF_OXM_HEADER = 188,
    OF_OXM_ICMPV4_CODE = 189,
    OF_OXM_ICMPV4_CODE_MASKED = 190,
    OF_OXM_ICMPV4_TYPE = 191,
    OF_OXM_ICMPV4_TYPE_MASKED = 192,
    OF_OXM_ICMPV6_CODE = 193,
    OF_OXM_ICMPV6_CODE_MASKED = 194,
    OF_OXM_ICMPV6_TYPE = 195,
    OF_OXM_ICMPV6_TYPE_MASKED = 196,
    OF_OXM_IN_PHY_PORT = 197,
    OF_OXM_IN_PHY_PORT_MASKED = 198,
    OF_OXM_IN_PORT = 199,
    OF_OXM_IN_PORT_MASKED = 200,
    OF_OXM_IP_DSCP = 201,
    OF_OXM_IP_DSCP_MASKED = 202,
    OF_OXM_IP_ECN = 203,
    OF_OXM_IP_ECN_MASKED = 204,
    OF_OXM_IP_PROTO = 205,
    OF_OXM_IP_PROTO_MASKED = 206,
    OF_OXM_IPV4_DST = 207,
    OF_OXM_IPV4_DST_MASKED = 208,
    OF_OXM_IPV4_SRC = 209,
    OF_OXM_IPV4_SRC_MASKED = 210,
    OF_OXM_IPV6_DST = 211,
    OF_OXM_IPV6_DST_MASKED = 212,
    OF_OXM_IPV6_FLABEL = 213,
    OF_OXM_IPV6_FLABEL_MASKED = 214,
    OF_OXM_IPV6_ND_SLL = 215,
    OF_OXM_IPV6_ND_SLL_MASKED = 216,
    OF_OXM_IPV6_ND_TARGET = 217,
    OF_OXM_IPV6_ND_TARGET_MASKED = 218,
    OF_OXM_IPV6_ND_TLL = 219,
    OF_OXM_IPV6_ND_TLL_MASKED = 220,
    OF_OXM_IPV6_SRC = 221,
    OF_OXM_IPV6_SRC_MASKED = 222,
    OF_OXM_METADATA = 223,
    OF_OXM_METADATA_MASKED = 224,
    OF_OXM_MPLS_LABEL = 225,
    OF_OXM_MPLS_LABEL_MASKED = 226,
    OF_OXM_MPLS_TC = 227,
    OF_OXM_MPLS_TC_MASKED = 228,
    OF_OXM_SCTP_DST = 229,
    OF_OXM_SCTP_DST_MASKED = 230,
    OF_OXM_SCTP_SRC = 231,
    OF_OXM_SCTP_SRC_MASKED = 232,
    OF_OXM_TCP_DST = 233,
    OF_OXM_TCP_DST_MASKED = 234,
    OF_OXM_TCP_SRC = 235,
    OF_OXM_TCP_SRC_MASKED = 236,
    OF_OXM_UDP_DST = 237,
    OF_OXM_UDP_DST_MASKED = 238,
    OF_OXM_UDP_SRC = 239,
    OF_OXM_UDP_SRC_MASKED = 240,
    OF_OXM_VLAN_PCP = 241,
    OF_OXM_VLAN_PCP_MASKED = 242,
    OF_OXM_VLAN_VID = 243,
    OF_OXM_VLAN_VID_MASKED = 244,
    OF_PACKET_QUEUE = 245,
    OF_PORT_DESC = 246,
    OF_PORT_STATS_ENTRY = 247,
    OF_QUEUE_PROP = 248,
    OF_QUEUE_PROP_EXPERIMENTER = 249,
    OF_QUEUE_PROP_HEADER = 250,
    OF_QUEUE_PROP_MAX_RATE = 251,
    OF_QUEUE_PROP_MIN_RATE = 252,
    OF_QUEUE_STATS_ENTRY = 253,
    OF_TABLE_FEATURE_PROP = 254,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 255,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 256,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 257,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 258,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 259,
    OF_TABLE_FEATURE_PROP_HEADER = 260,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 261,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 262,
    OF_TABLE_FEATURE_PROP_MATCH = 263,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 264,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 265,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 266,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 267,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 268,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 269,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 270,
    OF_TABLE_FEATURES = 271,
    OF_TABLE_STATS_ENTRY = 272,
    OF_UINT32 = 273,
    OF_UINT8 = 274,

    /* List objects */
    OF_LIST_ACTION = 275,
    OF_LIST_ACTION_ID = 276,
    OF_LIST_BSN_INTERFACE = 277,
    OF_LIST_BUCKET = 278,
    OF_LIST_BUCKET_COUNTER = 279,
    OF_LIST_FLOW_STATS_ENTRY = 280,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 281,
    OF_LIST_GROUP_STATS_ENTRY = 282,
    OF_LIST_HELLO_ELEM = 283,
    OF_LIST_INSTRUCTION = 284,
    OF_LIST_METER_BAND = 285,
    OF_LIST_METER_BAND_STATS = 286,
    OF_LIST_METER_STATS = 287,
    OF_LIST_OXM = 288,
    OF_LIST_PACKET_QUEUE = 289,
    OF_LIST_PORT_DESC = 290,
    OF_LIST_PORT_STATS_ENTRY = 291,
    OF_LIST_QUEUE_PROP = 292,
    OF_LIST_QUEUE_STATS_ENTRY = 293,
    OF_LIST_TABLE_FEATURE_PROP = 294,
    OF_LIST_TABLE_FEATURES = 295,
    OF_LIST_TABLE_STATS_ENTRY = 296,
    OF_LIST_UINT32 = 297,
    OF_LIST_UINT8 = 298,
...
#define OF_MESSAGE_OBJECT_COUNT 80
