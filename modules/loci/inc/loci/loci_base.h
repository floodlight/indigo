...
typedef enum of_object_id_e {
    ...
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 26,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 27,
    OF_BSN_SHELL_COMMAND = 28,
    OF_BSN_SHELL_OUTPUT = 29,
    OF_BSN_SHELL_STATUS = 30,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 31,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 32,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 33,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 34,
    OF_DESC_STATS_REPLY = 35,
    OF_DESC_STATS_REQUEST = 36,
    OF_ECHO_REPLY = 37,
    OF_ECHO_REQUEST = 38,
    OF_ERROR_MSG = 39,
    OF_EXPERIMENTER = 40,
    OF_EXPERIMENTER_STATS_REPLY = 41,
    OF_EXPERIMENTER_STATS_REQUEST = 42,
    OF_FEATURES_REPLY = 43,
    OF_FEATURES_REQUEST = 44,
    OF_FLOW_ADD = 45,
    OF_FLOW_DELETE = 46,
    OF_FLOW_DELETE_STRICT = 47,
    OF_FLOW_MODIFY = 48,
    OF_FLOW_MODIFY_STRICT = 49,
    OF_FLOW_REMOVED = 50,
    OF_FLOW_STATS_REPLY = 51,
    OF_FLOW_STATS_REQUEST = 52,
    OF_GET_CONFIG_REPLY = 53,
    OF_GET_CONFIG_REQUEST = 54,
    OF_GROUP_DESC_STATS_REPLY = 55,
    OF_GROUP_DESC_STATS_REQUEST = 56,
    OF_GROUP_FEATURES_STATS_REPLY = 57,
    OF_GROUP_FEATURES_STATS_REQUEST = 58,
    OF_GROUP_MOD = 59,
    OF_GROUP_STATS_REPLY = 60,
    OF_GROUP_STATS_REQUEST = 61,
    OF_HELLO = 62,
    OF_METER_CONFIG_STATS_REPLY = 63,
    OF_METER_CONFIG_STATS_REQUEST = 64,
    OF_METER_FEATURES_STATS_REPLY = 65,
    OF_METER_FEATURES_STATS_REQUEST = 66,
    OF_METER_MOD = 67,
    OF_METER_STATS_REPLY = 68,
    OF_METER_STATS_REQUEST = 69,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 70,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 71,
    OF_PACKET_IN = 72,
    OF_PACKET_OUT = 73,
    OF_PORT_DESC_STATS_REPLY = 74,
    OF_PORT_DESC_STATS_REQUEST = 75,
    OF_PORT_MOD = 76,
    OF_PORT_STATS_REPLY = 77,
    OF_PORT_STATS_REQUEST = 78,
    OF_PORT_STATUS = 79,
    OF_QUEUE_GET_CONFIG_REPLY = 80,
    OF_QUEUE_GET_CONFIG_REQUEST = 81,
    OF_QUEUE_STATS_REPLY = 82,
    OF_QUEUE_STATS_REQUEST = 83,
    OF_ROLE_REPLY = 84,
    OF_ROLE_REQUEST = 85,
    OF_SET_CONFIG = 86,
    OF_TABLE_FEATURES_STATS_REPLY = 87,
    OF_TABLE_FEATURES_STATS_REQUEST = 88,
    OF_TABLE_MOD = 89,
    OF_TABLE_STATS_REPLY = 90,
    OF_TABLE_STATS_REQUEST = 91,

    /* Non-message objects */
    OF_ACTION = 92,
    OF_ACTION_BSN_MIRROR = 93,
    OF_ACTION_BSN_SET_TUNNEL_DST = 94,
    OF_ACTION_COPY_TTL_IN = 95,
    OF_ACTION_COPY_TTL_OUT = 96,
    OF_ACTION_DEC_MPLS_TTL = 97,
    OF_ACTION_DEC_NW_TTL = 98,
    OF_ACTION_ENQUEUE = 99,
    OF_ACTION_EXPERIMENTER = 100,
    OF_ACTION_GROUP = 101,
    OF_ACTION_HEADER = 102,
    OF_ACTION_ID = 103,
    OF_ACTION_ID_BSN_MIRROR = 104,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 105,
    OF_ACTION_ID_COPY_TTL_IN = 106,
    OF_ACTION_ID_COPY_TTL_OUT = 107,
    OF_ACTION_ID_DEC_MPLS_TTL = 108,
    OF_ACTION_ID_DEC_NW_TTL = 109,
    OF_ACTION_ID_EXPERIMENTER = 110,
    OF_ACTION_ID_GROUP = 111,
    OF_ACTION_ID_HEADER = 112,
    OF_ACTION_ID_NICIRA_DEC_TTL = 113,
    OF_ACTION_ID_OUTPUT = 114,
    OF_ACTION_ID_POP_MPLS = 115,
    OF_ACTION_ID_POP_PBB = 116,
    OF_ACTION_ID_POP_VLAN = 117,
    OF_ACTION_ID_PUSH_MPLS = 118,
    OF_ACTION_ID_PUSH_PBB = 119,
    OF_ACTION_ID_PUSH_VLAN = 120,
    OF_ACTION_ID_SET_FIELD = 121,
    OF_ACTION_ID_SET_MPLS_TTL = 122,
    OF_ACTION_ID_SET_NW_TTL = 123,
    OF_ACTION_ID_SET_QUEUE = 124,
    OF_ACTION_NICIRA_DEC_TTL = 125,
    OF_ACTION_OUTPUT = 126,
    OF_ACTION_POP_MPLS = 127,
    OF_ACTION_POP_PBB = 128,
    OF_ACTION_POP_VLAN = 129,
    OF_ACTION_PUSH_MPLS = 130,
    OF_ACTION_PUSH_PBB = 131,
    OF_ACTION_PUSH_VLAN = 132,
    OF_ACTION_SET_DL_DST = 133,
    OF_ACTION_SET_DL_SRC = 134,
    OF_ACTION_SET_FIELD = 135,
    OF_ACTION_SET_MPLS_LABEL = 136,
    OF_ACTION_SET_MPLS_TC = 137,
    OF_ACTION_SET_MPLS_TTL = 138,
    OF_ACTION_SET_NW_DST = 139,
    OF_ACTION_SET_NW_ECN = 140,
    OF_ACTION_SET_NW_SRC = 141,
    OF_ACTION_SET_NW_TOS = 142,
    OF_ACTION_SET_NW_TTL = 143,
    OF_ACTION_SET_QUEUE = 144,
    OF_ACTION_SET_TP_DST = 145,
    OF_ACTION_SET_TP_SRC = 146,
    OF_ACTION_SET_VLAN_PCP = 147,
    OF_ACTION_SET_VLAN_VID = 148,
    OF_ACTION_STRIP_VLAN = 149,
    OF_BSN_INTERFACE = 150,
    OF_BSN_VPORT = 151,
    OF_BSN_VPORT_HEADER = 152,
    OF_BSN_VPORT_Q_IN_Q = 153,
    OF_BUCKET = 154,
    OF_BUCKET_COUNTER = 155,
    OF_EXPERIMENTER_MULTIPART_HEADER = 156,
    OF_FLOW_STATS_ENTRY = 157,
    OF_GROUP_DESC_STATS_ENTRY = 158,
    OF_GROUP_STATS_ENTRY = 159,
    OF_HEADER = 160,
    OF_HELLO_ELEM = 161,
    OF_HELLO_ELEM_HEADER = 162,
    OF_HELLO_ELEM_VERSIONBITMAP = 163,
    OF_INSTRUCTION = 164,
    OF_INSTRUCTION_APPLY_ACTIONS = 165,
    OF_INSTRUCTION_CLEAR_ACTIONS = 166,
    OF_INSTRUCTION_EXPERIMENTER = 167,
    OF_INSTRUCTION_GOTO_TABLE = 168,
    OF_INSTRUCTION_HEADER = 169,
    OF_INSTRUCTION_METER = 170,
    OF_INSTRUCTION_WRITE_ACTIONS = 171,
    OF_INSTRUCTION_WRITE_METADATA = 172,
    OF_MATCH_V1 = 173,
    OF_MATCH_V2 = 174,
    OF_MATCH_V3 = 175,
    OF_METER_BAND = 176,
    OF_METER_BAND_DROP = 177,
    OF_METER_BAND_DSCP_REMARK = 178,
    OF_METER_BAND_EXPERIMENTER = 179,
    OF_METER_BAND_HEADER = 180,
    OF_METER_BAND_STATS = 181,
    OF_METER_CONFIG = 182,
    OF_METER_FEATURES = 183,
    OF_METER_STATS = 184,
    OF_OXM = 185,
    OF_OXM_ARP_OP = 186,
    OF_OXM_ARP_OP_MASKED = 187,
    OF_OXM_ARP_SHA = 188,
    OF_OXM_ARP_SHA_MASKED = 189,
    OF_OXM_ARP_SPA = 190,
    OF_OXM_ARP_SPA_MASKED = 191,
    OF_OXM_ARP_THA = 192,
...
#define OF_MESSAGE_OBJECT_COUNT 92
