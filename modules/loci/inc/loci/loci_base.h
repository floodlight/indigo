...
typedef enum of_object_id_e {
    ...
    OF_GROUP_DESC_STATS_REPLY = 94,
    OF_GROUP_DESC_STATS_REQUEST = 95,
    OF_GROUP_FEATURES_STATS_REPLY = 96,
    OF_GROUP_FEATURES_STATS_REQUEST = 97,
    OF_GROUP_MOD = 98,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 99,
    OF_GROUP_STATS_REPLY = 100,
    OF_GROUP_STATS_REQUEST = 101,
    OF_HELLO = 102,
    OF_HELLO_FAILED_ERROR_MSG = 103,
    OF_METER_CONFIG_STATS_REPLY = 104,
    OF_METER_CONFIG_STATS_REQUEST = 105,
    OF_METER_FEATURES_STATS_REPLY = 106,
    OF_METER_FEATURES_STATS_REQUEST = 107,
    OF_METER_MOD = 108,
    OF_METER_MOD_FAILED_ERROR_MSG = 109,
    OF_METER_STATS_REPLY = 110,
    OF_METER_STATS_REQUEST = 111,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 112,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 113,
    OF_NICIRA_HEADER = 114,
    OF_PACKET_IN = 115,
    OF_PACKET_OUT = 116,
    OF_PORT_DESC_STATS_REPLY = 117,
    OF_PORT_DESC_STATS_REQUEST = 118,
    OF_PORT_MOD = 119,
    OF_PORT_MOD_FAILED_ERROR_MSG = 120,
    OF_PORT_STATS_REPLY = 121,
    OF_PORT_STATS_REQUEST = 122,
    OF_PORT_STATUS = 123,
    OF_QUEUE_GET_CONFIG_REPLY = 124,
    OF_QUEUE_GET_CONFIG_REQUEST = 125,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 126,
    OF_QUEUE_STATS_REPLY = 127,
    OF_QUEUE_STATS_REQUEST = 128,
    OF_ROLE_REPLY = 129,
    OF_ROLE_REQUEST = 130,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 131,
    OF_SET_CONFIG = 132,
    OF_STATS_REPLY = 133,
    OF_STATS_REQUEST = 134,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 135,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 136,
    OF_TABLE_FEATURES_STATS_REPLY = 137,
    OF_TABLE_FEATURES_STATS_REQUEST = 138,
    OF_TABLE_MOD = 139,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 140,
    OF_TABLE_STATS_REPLY = 141,
    OF_TABLE_STATS_REQUEST = 142,

    /* Non-message objects */
    OF_ACTION = 143,
    OF_ACTION_BSN = 144,
    OF_ACTION_BSN_MIRROR = 145,
    OF_ACTION_BSN_SET_TUNNEL_DST = 146,
    OF_ACTION_COPY_TTL_IN = 147,
    OF_ACTION_COPY_TTL_OUT = 148,
    OF_ACTION_DEC_MPLS_TTL = 149,
    OF_ACTION_DEC_NW_TTL = 150,
    OF_ACTION_ENQUEUE = 151,
    OF_ACTION_EXPERIMENTER = 152,
    OF_ACTION_GROUP = 153,
    OF_ACTION_HEADER = 154,
    OF_ACTION_ID = 155,
    OF_ACTION_ID_BSN = 156,
    OF_ACTION_ID_BSN_MIRROR = 157,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 158,
    OF_ACTION_ID_COPY_TTL_IN = 159,
    OF_ACTION_ID_COPY_TTL_OUT = 160,
    OF_ACTION_ID_DEC_MPLS_TTL = 161,
    OF_ACTION_ID_DEC_NW_TTL = 162,
    OF_ACTION_ID_EXPERIMENTER = 163,
    OF_ACTION_ID_GROUP = 164,
    OF_ACTION_ID_HEADER = 165,
    OF_ACTION_ID_NICIRA = 166,
    OF_ACTION_ID_NICIRA_DEC_TTL = 167,
    OF_ACTION_ID_OUTPUT = 168,
    OF_ACTION_ID_POP_MPLS = 169,
    OF_ACTION_ID_POP_PBB = 170,
    OF_ACTION_ID_POP_VLAN = 171,
    OF_ACTION_ID_PUSH_MPLS = 172,
    OF_ACTION_ID_PUSH_PBB = 173,
    OF_ACTION_ID_PUSH_VLAN = 174,
    OF_ACTION_ID_SET_FIELD = 175,
    OF_ACTION_ID_SET_MPLS_TTL = 176,
    OF_ACTION_ID_SET_NW_TTL = 177,
    OF_ACTION_ID_SET_QUEUE = 178,
    OF_ACTION_NICIRA = 179,
    OF_ACTION_NICIRA_DEC_TTL = 180,
    OF_ACTION_OUTPUT = 181,
    OF_ACTION_POP_MPLS = 182,
    OF_ACTION_POP_PBB = 183,
    OF_ACTION_POP_VLAN = 184,
    OF_ACTION_PUSH_MPLS = 185,
    OF_ACTION_PUSH_PBB = 186,
    OF_ACTION_PUSH_VLAN = 187,
    OF_ACTION_SET_DL_DST = 188,
    OF_ACTION_SET_DL_SRC = 189,
    OF_ACTION_SET_FIELD = 190,
    OF_ACTION_SET_MPLS_LABEL = 191,
    OF_ACTION_SET_MPLS_TC = 192,
    OF_ACTION_SET_MPLS_TTL = 193,
    OF_ACTION_SET_NW_DST = 194,
    OF_ACTION_SET_NW_ECN = 195,
    OF_ACTION_SET_NW_SRC = 196,
    OF_ACTION_SET_NW_TOS = 197,
    OF_ACTION_SET_NW_TTL = 198,
    OF_ACTION_SET_QUEUE = 199,
    OF_ACTION_SET_TP_DST = 200,
    OF_ACTION_SET_TP_SRC = 201,
    OF_ACTION_SET_VLAN_PCP = 202,
    OF_ACTION_SET_VLAN_VID = 203,
    OF_ACTION_STRIP_VLAN = 204,
    OF_BSN_INTERFACE = 205,
    OF_BSN_LACP_STATS_ENTRY = 206,
    OF_BSN_PORT_COUNTER_STATS_ENTRY = 207,
    OF_BSN_SWITCH_PIPELINE_STATS_ENTRY = 208,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 209,
    OF_BSN_VPORT = 210,
    OF_BSN_VPORT_HEADER = 211,
    OF_BSN_VPORT_Q_IN_Q = 212,
    OF_BUCKET = 213,
    OF_BUCKET_COUNTER = 214,
    OF_EXPERIMENTER_STATS_HEADER = 215,
    OF_FLOW_STATS_ENTRY = 216,
    OF_GROUP_DESC_STATS_ENTRY = 217,
    OF_GROUP_STATS_ENTRY = 218,
    OF_HEADER = 219,
    OF_HELLO_ELEM = 220,
    OF_HELLO_ELEM_HEADER = 221,
    OF_HELLO_ELEM_VERSIONBITMAP = 222,
    OF_INSTRUCTION = 223,
    OF_INSTRUCTION_APPLY_ACTIONS = 224,
    OF_INSTRUCTION_BSN = 225,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 226,
    OF_INSTRUCTION_CLEAR_ACTIONS = 227,
    OF_INSTRUCTION_EXPERIMENTER = 228,
    OF_INSTRUCTION_GOTO_TABLE = 229,
    OF_INSTRUCTION_HEADER = 230,
    OF_INSTRUCTION_METER = 231,
    OF_INSTRUCTION_WRITE_ACTIONS = 232,
    OF_INSTRUCTION_WRITE_METADATA = 233,
    OF_MATCH_V1 = 234,
    OF_MATCH_V2 = 235,
    OF_MATCH_V3 = 236,
    OF_METER_BAND = 237,
    OF_METER_BAND_DROP = 238,
    OF_METER_BAND_DSCP_REMARK = 239,
    OF_METER_BAND_EXPERIMENTER = 240,
    OF_METER_BAND_HEADER = 241,
    OF_METER_BAND_STATS = 242,
    OF_METER_CONFIG = 243,
    OF_METER_FEATURES = 244,
    OF_METER_STATS = 245,
    OF_OXM = 246,
    OF_OXM_ARP_OP = 247,
    OF_OXM_ARP_OP_MASKED = 248,
    OF_OXM_ARP_SHA = 249,
    OF_OXM_ARP_SHA_MASKED = 250,
    OF_OXM_ARP_SPA = 251,
    OF_OXM_ARP_SPA_MASKED = 252,
    OF_OXM_ARP_THA = 253,
    OF_OXM_ARP_THA_MASKED = 254,
    OF_OXM_ARP_TPA = 255,
    OF_OXM_ARP_TPA_MASKED = 256,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 257,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 258,
    OF_OXM_BSN_IN_PORTS_128 = 259,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 260,
    OF_OXM_BSN_L3_DST_CLASS_ID = 261,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 262,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 263,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 264,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 265,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 266,
    OF_OXM_BSN_LAG_ID = 267,
    OF_OXM_BSN_LAG_ID_MASKED = 268,
    OF_OXM_BSN_VRF = 269,
    OF_OXM_BSN_VRF_MASKED = 270,
    OF_OXM_ETH_DST = 271,
    OF_OXM_ETH_DST_MASKED = 272,
    OF_OXM_ETH_SRC = 273,
    OF_OXM_ETH_SRC_MASKED = 274,
    OF_OXM_ETH_TYPE = 275,
    OF_OXM_ETH_TYPE_MASKED = 276,
    OF_OXM_HEADER = 277,
    OF_OXM_ICMPV4_CODE = 278,
    OF_OXM_ICMPV4_CODE_MASKED = 279,
    OF_OXM_ICMPV4_TYPE = 280,
    OF_OXM_ICMPV4_TYPE_MASKED = 281,
    OF_OXM_ICMPV6_CODE = 282,
    OF_OXM_ICMPV6_CODE_MASKED = 283,
    OF_OXM_ICMPV6_TYPE = 284,
    OF_OXM_ICMPV6_TYPE_MASKED = 285,
    OF_OXM_IN_PHY_PORT = 286,
    OF_OXM_IN_PHY_PORT_MASKED = 287,
    OF_OXM_IN_PORT = 288,
    OF_OXM_IN_PORT_MASKED = 289,
    OF_OXM_IP_DSCP = 290,
    OF_OXM_IP_DSCP_MASKED = 291,
    OF_OXM_IP_ECN = 292,
    OF_OXM_IP_ECN_MASKED = 293,
    OF_OXM_IP_PROTO = 294,
    OF_OXM_IP_PROTO_MASKED = 295,
    OF_OXM_IPV4_DST = 296,
    OF_OXM_IPV4_DST_MASKED = 297,
    OF_OXM_IPV4_SRC = 298,
    OF_OXM_IPV4_SRC_MASKED = 299,
    OF_OXM_IPV6_DST = 300,
    OF_OXM_IPV6_DST_MASKED = 301,
    OF_OXM_IPV6_FLABEL = 302,
    OF_OXM_IPV6_FLABEL_MASKED = 303,
    OF_OXM_IPV6_ND_SLL = 304,
    OF_OXM_IPV6_ND_SLL_MASKED = 305,
    OF_OXM_IPV6_ND_TARGET = 306,
    OF_OXM_IPV6_ND_TARGET_MASKED = 307,
    OF_OXM_IPV6_ND_TLL = 308,
    OF_OXM_IPV6_ND_TLL_MASKED = 309,
    OF_OXM_IPV6_SRC = 310,
    OF_OXM_IPV6_SRC_MASKED = 311,
    OF_OXM_METADATA = 312,
    OF_OXM_METADATA_MASKED = 313,
    OF_OXM_MPLS_LABEL = 314,
    OF_OXM_MPLS_LABEL_MASKED = 315,
    OF_OXM_MPLS_TC = 316,
    OF_OXM_MPLS_TC_MASKED = 317,
    OF_OXM_SCTP_DST = 318,
    OF_OXM_SCTP_DST_MASKED = 319,
    OF_OXM_SCTP_SRC = 320,
    OF_OXM_SCTP_SRC_MASKED = 321,
    OF_OXM_TCP_DST = 322,
    OF_OXM_TCP_DST_MASKED = 323,
    OF_OXM_TCP_SRC = 324,
    OF_OXM_TCP_SRC_MASKED = 325,
    OF_OXM_UDP_DST = 326,
    OF_OXM_UDP_DST_MASKED = 327,
    OF_OXM_UDP_SRC = 328,
    OF_OXM_UDP_SRC_MASKED = 329,
    OF_OXM_VLAN_PCP = 330,
    OF_OXM_VLAN_PCP_MASKED = 331,
    OF_OXM_VLAN_VID = 332,
    OF_OXM_VLAN_VID_MASKED = 333,
    OF_PACKET_QUEUE = 334,
    OF_PORT_DESC = 335,
    OF_PORT_STATS_ENTRY = 336,
    OF_QUEUE_PROP = 337,
    OF_QUEUE_PROP_EXPERIMENTER = 338,
    OF_QUEUE_PROP_HEADER = 339,
    OF_QUEUE_PROP_MAX_RATE = 340,
    OF_QUEUE_PROP_MIN_RATE = 341,
    OF_QUEUE_STATS_ENTRY = 342,
    OF_TABLE_FEATURE_PROP = 343,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 344,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 345,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 346,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 347,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 348,
    OF_TABLE_FEATURE_PROP_HEADER = 349,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 350,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 351,
    OF_TABLE_FEATURE_PROP_MATCH = 352,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 353,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 354,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 355,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 356,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 357,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 358,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 359,
    OF_TABLE_FEATURES = 360,
    OF_TABLE_STATS_ENTRY = 361,
    OF_UINT32 = 362,
    OF_UINT64 = 363,
    OF_UINT8 = 364,
    ...
    /* List objects */
    OF_LIST_ACTION = 365,
    OF_LIST_ACTION_ID = 366,
    OF_LIST_BSN_INTERFACE = 367,
    OF_LIST_BSN_LACP_STATS_ENTRY = 368,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 369,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 370,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 371,
    OF_LIST_BUCKET = 372,
    OF_LIST_BUCKET_COUNTER = 373,
    OF_LIST_FLOW_STATS_ENTRY = 374,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 375,
    OF_LIST_GROUP_STATS_ENTRY = 376,
    OF_LIST_HELLO_ELEM = 377,
    OF_LIST_INSTRUCTION = 378,
    OF_LIST_METER_BAND = 379,
    OF_LIST_METER_BAND_STATS = 380,
    OF_LIST_METER_STATS = 381,
    OF_LIST_OXM = 382,
    OF_LIST_PACKET_QUEUE = 383,
    OF_LIST_PORT_DESC = 384,
    OF_LIST_PORT_STATS_ENTRY = 385,
    OF_LIST_QUEUE_PROP = 386,
    OF_LIST_QUEUE_STATS_ENTRY = 387,
    OF_LIST_TABLE_FEATURE_PROP = 388,
    OF_LIST_TABLE_FEATURES = 389,
    OF_LIST_TABLE_STATS_ENTRY = 390,
    OF_LIST_UINT32 = 391,
    OF_LIST_UINT64 = 392,
    OF_LIST_UINT8 = 393,
...
#define OF_MESSAGE_OBJECT_COUNT 143
