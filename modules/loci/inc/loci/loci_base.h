...
typedef enum of_object_id_e {
    ...
    OF_INSTRUCTION_BSN = 212,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 213,
    OF_INSTRUCTION_CLEAR_ACTIONS = 214,
    OF_INSTRUCTION_EXPERIMENTER = 215,
    OF_INSTRUCTION_GOTO_TABLE = 216,
    OF_INSTRUCTION_HEADER = 217,
    OF_INSTRUCTION_METER = 218,
    OF_INSTRUCTION_WRITE_ACTIONS = 219,
    OF_INSTRUCTION_WRITE_METADATA = 220,
    OF_MATCH_V1 = 221,
    OF_MATCH_V2 = 222,
    OF_MATCH_V3 = 223,
    OF_METER_BAND = 224,
    OF_METER_BAND_DROP = 225,
    OF_METER_BAND_DSCP_REMARK = 226,
    OF_METER_BAND_EXPERIMENTER = 227,
    OF_METER_BAND_HEADER = 228,
    OF_METER_BAND_STATS = 229,
    OF_METER_CONFIG = 230,
    OF_METER_FEATURES = 231,
    OF_METER_STATS = 232,
    OF_OXM = 233,
    OF_OXM_ARP_OP = 234,
    OF_OXM_ARP_OP_MASKED = 235,
    OF_OXM_ARP_SHA = 236,
    OF_OXM_ARP_SHA_MASKED = 237,
    OF_OXM_ARP_SPA = 238,
    OF_OXM_ARP_SPA_MASKED = 239,
    OF_OXM_ARP_THA = 240,
    OF_OXM_ARP_THA_MASKED = 241,
    OF_OXM_ARP_TPA = 242,
    OF_OXM_ARP_TPA_MASKED = 243,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 244,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 245,
    OF_OXM_BSN_IN_PORTS_128 = 246,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 247,
    OF_OXM_BSN_L3_DST_CLASS_ID = 248,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 249,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 250,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 251,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 252,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 253,
    OF_OXM_BSN_LAG_ID = 254,
    OF_OXM_BSN_LAG_ID_MASKED = 255,
    OF_OXM_BSN_VRF = 256,
    OF_OXM_BSN_VRF_MASKED = 257,
    OF_OXM_ETH_DST = 258,
    OF_OXM_ETH_DST_MASKED = 259,
    OF_OXM_ETH_SRC = 260,
    OF_OXM_ETH_SRC_MASKED = 261,
    OF_OXM_ETH_TYPE = 262,
    OF_OXM_ETH_TYPE_MASKED = 263,
    OF_OXM_HEADER = 264,
    OF_OXM_ICMPV4_CODE = 265,
    OF_OXM_ICMPV4_CODE_MASKED = 266,
    OF_OXM_ICMPV4_TYPE = 267,
    OF_OXM_ICMPV4_TYPE_MASKED = 268,
    OF_OXM_ICMPV6_CODE = 269,
    OF_OXM_ICMPV6_CODE_MASKED = 270,
    OF_OXM_ICMPV6_TYPE = 271,
    OF_OXM_ICMPV6_TYPE_MASKED = 272,
    OF_OXM_IN_PHY_PORT = 273,
    OF_OXM_IN_PHY_PORT_MASKED = 274,
    OF_OXM_IN_PORT = 275,
    OF_OXM_IN_PORT_MASKED = 276,
    OF_OXM_IP_DSCP = 277,
    OF_OXM_IP_DSCP_MASKED = 278,
    OF_OXM_IP_ECN = 279,
    OF_OXM_IP_ECN_MASKED = 280,
    OF_OXM_IP_PROTO = 281,
    OF_OXM_IP_PROTO_MASKED = 282,
    OF_OXM_IPV4_DST = 283,
    OF_OXM_IPV4_DST_MASKED = 284,
    OF_OXM_IPV4_SRC = 285,
    OF_OXM_IPV4_SRC_MASKED = 286,
    OF_OXM_IPV6_DST = 287,
    OF_OXM_IPV6_DST_MASKED = 288,
    OF_OXM_IPV6_FLABEL = 289,
    OF_OXM_IPV6_FLABEL_MASKED = 290,
    OF_OXM_IPV6_ND_SLL = 291,
    OF_OXM_IPV6_ND_SLL_MASKED = 292,
    OF_OXM_IPV6_ND_TARGET = 293,
    OF_OXM_IPV6_ND_TARGET_MASKED = 294,
    OF_OXM_IPV6_ND_TLL = 295,
    OF_OXM_IPV6_ND_TLL_MASKED = 296,
    OF_OXM_IPV6_SRC = 297,
    OF_OXM_IPV6_SRC_MASKED = 298,
    OF_OXM_METADATA = 299,
    OF_OXM_METADATA_MASKED = 300,
    OF_OXM_MPLS_LABEL = 301,
    OF_OXM_MPLS_LABEL_MASKED = 302,
    OF_OXM_MPLS_TC = 303,
    OF_OXM_MPLS_TC_MASKED = 304,
    OF_OXM_SCTP_DST = 305,
    OF_OXM_SCTP_DST_MASKED = 306,
    OF_OXM_SCTP_SRC = 307,
    OF_OXM_SCTP_SRC_MASKED = 308,
    OF_OXM_TCP_DST = 309,
    OF_OXM_TCP_DST_MASKED = 310,
    OF_OXM_TCP_SRC = 311,
    OF_OXM_TCP_SRC_MASKED = 312,
    OF_OXM_UDP_DST = 313,
    OF_OXM_UDP_DST_MASKED = 314,
    OF_OXM_UDP_SRC = 315,
    OF_OXM_UDP_SRC_MASKED = 316,
    OF_OXM_VLAN_PCP = 317,
    OF_OXM_VLAN_PCP_MASKED = 318,
    OF_OXM_VLAN_VID = 319,
    OF_OXM_VLAN_VID_MASKED = 320,
    OF_PACKET_QUEUE = 321,
    OF_PORT_DESC = 322,
    OF_PORT_STATS_ENTRY = 323,
    OF_QUEUE_PROP = 324,
    OF_QUEUE_PROP_EXPERIMENTER = 325,
    OF_QUEUE_PROP_HEADER = 326,
    OF_QUEUE_PROP_MAX_RATE = 327,
    OF_QUEUE_PROP_MIN_RATE = 328,
    OF_QUEUE_STATS_ENTRY = 329,
    OF_TABLE_FEATURE_PROP = 330,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 331,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 332,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 333,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 334,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 335,
    OF_TABLE_FEATURE_PROP_HEADER = 336,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 337,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 338,
    OF_TABLE_FEATURE_PROP_MATCH = 339,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 340,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 341,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 342,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 343,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 344,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 345,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 346,
    OF_TABLE_FEATURES = 347,
    OF_TABLE_STATS_ENTRY = 348,
    OF_UINT32 = 349,
    OF_UINT8 = 350,

    /* List objects */
    OF_LIST_ACTION = 351,
    OF_LIST_ACTION_ID = 352,
    OF_LIST_BSN_INTERFACE = 353,
    OF_LIST_BSN_LACP_STATS_ENTRY = 354,
    OF_LIST_BUCKET = 355,
    OF_LIST_BUCKET_COUNTER = 356,
    OF_LIST_FLOW_STATS_ENTRY = 357,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 358,
    OF_LIST_GROUP_STATS_ENTRY = 359,
    OF_LIST_HELLO_ELEM = 360,
    OF_LIST_INSTRUCTION = 361,
    OF_LIST_METER_BAND = 362,
    OF_LIST_METER_BAND_STATS = 363,
    OF_LIST_METER_STATS = 364,
    OF_LIST_OXM = 365,
    OF_LIST_PACKET_QUEUE = 366,
    OF_LIST_PORT_DESC = 367,
    OF_LIST_PORT_STATS_ENTRY = 368,
    OF_LIST_QUEUE_PROP = 369,
    OF_LIST_QUEUE_STATS_ENTRY = 370,
    OF_LIST_TABLE_FEATURE_PROP = 371,
    OF_LIST_TABLE_FEATURES = 372,
    OF_LIST_TABLE_STATS_ENTRY = 373,
    OF_LIST_UINT32 = 374,
    OF_LIST_UINT8 = 375,
