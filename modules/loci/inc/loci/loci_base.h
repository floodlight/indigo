...
typedef enum of_object_id_e {
    ...
    OF_BSN_PDU_RX_REPLY = 34,
    OF_BSN_PDU_RX_REQUEST = 35,
    OF_BSN_PDU_RX_TIMEOUT = 36,
    OF_BSN_PDU_TX_REPLY = 37,
    OF_BSN_PDU_TX_REQUEST = 38,
    OF_BSN_SET_IP_MASK = 39,
    OF_BSN_SET_L2_TABLE_REPLY = 40,
    OF_BSN_SET_L2_TABLE_REQUEST = 41,
    OF_BSN_SET_MIRRORING = 42,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 43,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 44,
    OF_BSN_SHELL_COMMAND = 45,
    OF_BSN_SHELL_OUTPUT = 46,
    OF_BSN_SHELL_STATUS = 47,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 48,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 49,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 50,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 51,
    OF_DESC_STATS_REPLY = 52,
    OF_DESC_STATS_REQUEST = 53,
    OF_ECHO_REPLY = 54,
    OF_ECHO_REQUEST = 55,
    OF_ERROR_MSG = 56,
    OF_EXPERIMENTER = 57,
    OF_EXPERIMENTER_ERROR_MSG = 58,
    OF_EXPERIMENTER_STATS_REPLY = 59,
    OF_EXPERIMENTER_STATS_REQUEST = 60,
    OF_FEATURES_REPLY = 61,
    OF_FEATURES_REQUEST = 62,
    OF_FLOW_ADD = 63,
    OF_FLOW_DELETE = 64,
    OF_FLOW_DELETE_STRICT = 65,
    OF_FLOW_MOD = 66,
    OF_FLOW_MOD_FAILED_ERROR_MSG = 67,
    OF_FLOW_MODIFY = 68,
    OF_FLOW_MODIFY_STRICT = 69,
    OF_FLOW_REMOVED = 70,
    OF_FLOW_STATS_REPLY = 71,
    OF_FLOW_STATS_REQUEST = 72,
    OF_GET_CONFIG_REPLY = 73,
    OF_GET_CONFIG_REQUEST = 74,
    OF_GROUP_DESC_STATS_REPLY = 75,
    OF_GROUP_DESC_STATS_REQUEST = 76,
    OF_GROUP_FEATURES_STATS_REPLY = 77,
    OF_GROUP_FEATURES_STATS_REQUEST = 78,
    OF_GROUP_MOD = 79,
    OF_GROUP_MOD_FAILED_ERROR_MSG = 80,
    OF_GROUP_STATS_REPLY = 81,
    OF_GROUP_STATS_REQUEST = 82,
    OF_HELLO = 83,
    OF_HELLO_FAILED_ERROR_MSG = 84,
    OF_METER_CONFIG_STATS_REPLY = 85,
    OF_METER_CONFIG_STATS_REQUEST = 86,
    OF_METER_FEATURES_STATS_REPLY = 87,
    OF_METER_FEATURES_STATS_REQUEST = 88,
    OF_METER_MOD = 89,
    OF_METER_MOD_FAILED_ERROR_MSG = 90,
    OF_METER_STATS_REPLY = 91,
    OF_METER_STATS_REQUEST = 92,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 93,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 94,
    OF_NICIRA_HEADER = 95,
    OF_PACKET_IN = 96,
    OF_PACKET_OUT = 97,
    OF_PORT_DESC_STATS_REPLY = 98,
    OF_PORT_DESC_STATS_REQUEST = 99,
    OF_PORT_MOD = 100,
    OF_PORT_MOD_FAILED_ERROR_MSG = 101,
    OF_PORT_STATS_REPLY = 102,
    OF_PORT_STATS_REQUEST = 103,
    OF_PORT_STATUS = 104,
    OF_QUEUE_GET_CONFIG_REPLY = 105,
    OF_QUEUE_GET_CONFIG_REQUEST = 106,
    OF_QUEUE_OP_FAILED_ERROR_MSG = 107,
    OF_QUEUE_STATS_REPLY = 108,
    OF_QUEUE_STATS_REQUEST = 109,
    OF_ROLE_REPLY = 110,
    OF_ROLE_REQUEST = 111,
    OF_ROLE_REQUEST_FAILED_ERROR_MSG = 112,
    OF_SET_CONFIG = 113,
    OF_STATS_REPLY = 114,
    OF_STATS_REQUEST = 115,
    OF_SWITCH_CONFIG_FAILED_ERROR_MSG = 116,
    OF_TABLE_FEATURES_FAILED_ERROR_MSG = 117,
    OF_TABLE_FEATURES_STATS_REPLY = 118,
    OF_TABLE_FEATURES_STATS_REQUEST = 119,
    OF_TABLE_MOD = 120,
    OF_TABLE_MOD_FAILED_ERROR_MSG = 121,
    OF_TABLE_STATS_REPLY = 122,
    OF_TABLE_STATS_REQUEST = 123,

    /* Non-message objects */
    OF_ACTION = 124,
    OF_ACTION_BSN = 125,
    OF_ACTION_BSN_MIRROR = 126,
    OF_ACTION_BSN_SET_TUNNEL_DST = 127,
    OF_ACTION_COPY_TTL_IN = 128,
    OF_ACTION_COPY_TTL_OUT = 129,
    OF_ACTION_DEC_MPLS_TTL = 130,
    OF_ACTION_DEC_NW_TTL = 131,
    OF_ACTION_ENQUEUE = 132,
    OF_ACTION_EXPERIMENTER = 133,
    OF_ACTION_GROUP = 134,
    OF_ACTION_HEADER = 135,
    OF_ACTION_ID = 136,
    OF_ACTION_ID_BSN = 137,
    OF_ACTION_ID_BSN_MIRROR = 138,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 139,
    OF_ACTION_ID_COPY_TTL_IN = 140,
    OF_ACTION_ID_COPY_TTL_OUT = 141,
    OF_ACTION_ID_DEC_MPLS_TTL = 142,
    OF_ACTION_ID_DEC_NW_TTL = 143,
    OF_ACTION_ID_EXPERIMENTER = 144,
    OF_ACTION_ID_GROUP = 145,
    OF_ACTION_ID_HEADER = 146,
    OF_ACTION_ID_NICIRA = 147,
    OF_ACTION_ID_NICIRA_DEC_TTL = 148,
    OF_ACTION_ID_OUTPUT = 149,
    OF_ACTION_ID_POP_MPLS = 150,
    OF_ACTION_ID_POP_PBB = 151,
    OF_ACTION_ID_POP_VLAN = 152,
    OF_ACTION_ID_PUSH_MPLS = 153,
    OF_ACTION_ID_PUSH_PBB = 154,
    OF_ACTION_ID_PUSH_VLAN = 155,
    OF_ACTION_ID_SET_FIELD = 156,
    OF_ACTION_ID_SET_MPLS_TTL = 157,
    OF_ACTION_ID_SET_NW_TTL = 158,
    OF_ACTION_ID_SET_QUEUE = 159,
    OF_ACTION_NICIRA = 160,
    OF_ACTION_NICIRA_DEC_TTL = 161,
    OF_ACTION_OUTPUT = 162,
    OF_ACTION_POP_MPLS = 163,
    OF_ACTION_POP_PBB = 164,
    OF_ACTION_POP_VLAN = 165,
    OF_ACTION_PUSH_MPLS = 166,
    OF_ACTION_PUSH_PBB = 167,
    OF_ACTION_PUSH_VLAN = 168,
    OF_ACTION_SET_DL_DST = 169,
    OF_ACTION_SET_DL_SRC = 170,
    OF_ACTION_SET_FIELD = 171,
    OF_ACTION_SET_MPLS_LABEL = 172,
    OF_ACTION_SET_MPLS_TC = 173,
    OF_ACTION_SET_MPLS_TTL = 174,
    OF_ACTION_SET_NW_DST = 175,
    OF_ACTION_SET_NW_ECN = 176,
    OF_ACTION_SET_NW_SRC = 177,
    OF_ACTION_SET_NW_TOS = 178,
    OF_ACTION_SET_NW_TTL = 179,
    OF_ACTION_SET_QUEUE = 180,
    OF_ACTION_SET_TP_DST = 181,
    OF_ACTION_SET_TP_SRC = 182,
    OF_ACTION_SET_VLAN_PCP = 183,
    OF_ACTION_SET_VLAN_VID = 184,
    OF_ACTION_STRIP_VLAN = 185,
    OF_BSN_INTERFACE = 186,
    OF_BSN_VPORT = 187,
    OF_BSN_VPORT_HEADER = 188,
    OF_BSN_VPORT_Q_IN_Q = 189,
    OF_BUCKET = 190,
    OF_BUCKET_COUNTER = 191,
    OF_EXPERIMENTER_STATS_HEADER = 192,
    OF_FLOW_STATS_ENTRY = 193,
    OF_GROUP_DESC_STATS_ENTRY = 194,
    OF_GROUP_STATS_ENTRY = 195,
    OF_HEADER = 196,
    OF_HELLO_ELEM = 197,
    OF_HELLO_ELEM_HEADER = 198,
    OF_HELLO_ELEM_VERSIONBITMAP = 199,
    OF_INSTRUCTION = 200,
    OF_INSTRUCTION_APPLY_ACTIONS = 201,
    OF_INSTRUCTION_CLEAR_ACTIONS = 202,
    OF_INSTRUCTION_EXPERIMENTER = 203,
    OF_INSTRUCTION_GOTO_TABLE = 204,
    OF_INSTRUCTION_HEADER = 205,
    OF_INSTRUCTION_METER = 206,
    OF_INSTRUCTION_WRITE_ACTIONS = 207,
    OF_INSTRUCTION_WRITE_METADATA = 208,
    OF_MATCH_V1 = 209,
    OF_MATCH_V2 = 210,
    OF_MATCH_V3 = 211,
    OF_METER_BAND = 212,
    OF_METER_BAND_DROP = 213,
    OF_METER_BAND_DSCP_REMARK = 214,
    OF_METER_BAND_EXPERIMENTER = 215,
    OF_METER_BAND_HEADER = 216,
    OF_METER_BAND_STATS = 217,
    OF_METER_CONFIG = 218,
    OF_METER_FEATURES = 219,
    OF_METER_STATS = 220,
    OF_OXM = 221,
    OF_OXM_ARP_OP = 222,
    OF_OXM_ARP_OP_MASKED = 223,
    OF_OXM_ARP_SHA = 224,
    OF_OXM_ARP_SHA_MASKED = 225,
    OF_OXM_ARP_SPA = 226,
    OF_OXM_ARP_SPA_MASKED = 227,
    OF_OXM_ARP_THA = 228,
    OF_OXM_ARP_THA_MASKED = 229,
    OF_OXM_ARP_TPA = 230,
    OF_OXM_ARP_TPA_MASKED = 231,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 232,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 233,
    OF_OXM_BSN_IN_PORTS_128 = 234,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 235,
    OF_OXM_BSN_L3_DST_CLASS_ID = 236,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 237,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 238,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 239,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 240,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 241,
    OF_OXM_BSN_LAG_ID = 242,
    OF_OXM_BSN_LAG_ID_MASKED = 243,
    OF_OXM_BSN_VRF = 244,
    OF_OXM_BSN_VRF_MASKED = 245,
    OF_OXM_ETH_DST = 246,
    OF_OXM_ETH_DST_MASKED = 247,
    OF_OXM_ETH_SRC = 248,
    OF_OXM_ETH_SRC_MASKED = 249,
    OF_OXM_ETH_TYPE = 250,
    OF_OXM_ETH_TYPE_MASKED = 251,
    OF_OXM_HEADER = 252,
    OF_OXM_ICMPV4_CODE = 253,
    OF_OXM_ICMPV4_CODE_MASKED = 254,
    OF_OXM_ICMPV4_TYPE = 255,
    OF_OXM_ICMPV4_TYPE_MASKED = 256,
    OF_OXM_ICMPV6_CODE = 257,
    OF_OXM_ICMPV6_CODE_MASKED = 258,
    OF_OXM_ICMPV6_TYPE = 259,
    OF_OXM_ICMPV6_TYPE_MASKED = 260,
    OF_OXM_IN_PHY_PORT = 261,
    OF_OXM_IN_PHY_PORT_MASKED = 262,
    OF_OXM_IN_PORT = 263,
    OF_OXM_IN_PORT_MASKED = 264,
    OF_OXM_IP_DSCP = 265,
    OF_OXM_IP_DSCP_MASKED = 266,
    OF_OXM_IP_ECN = 267,
    OF_OXM_IP_ECN_MASKED = 268,
    OF_OXM_IP_PROTO = 269,
    OF_OXM_IP_PROTO_MASKED = 270,
    OF_OXM_IPV4_DST = 271,
    OF_OXM_IPV4_DST_MASKED = 272,
    OF_OXM_IPV4_SRC = 273,
    OF_OXM_IPV4_SRC_MASKED = 274,
    OF_OXM_IPV6_DST = 275,
    OF_OXM_IPV6_DST_MASKED = 276,
    OF_OXM_IPV6_FLABEL = 277,
    OF_OXM_IPV6_FLABEL_MASKED = 278,
    OF_OXM_IPV6_ND_SLL = 279,
    OF_OXM_IPV6_ND_SLL_MASKED = 280,
    OF_OXM_IPV6_ND_TARGET = 281,
    OF_OXM_IPV6_ND_TARGET_MASKED = 282,
    OF_OXM_IPV6_ND_TLL = 283,
    OF_OXM_IPV6_ND_TLL_MASKED = 284,
    OF_OXM_IPV6_SRC = 285,
    OF_OXM_IPV6_SRC_MASKED = 286,
    OF_OXM_METADATA = 287,
    OF_OXM_METADATA_MASKED = 288,
    OF_OXM_MPLS_LABEL = 289,
    OF_OXM_MPLS_LABEL_MASKED = 290,
    OF_OXM_MPLS_TC = 291,
    OF_OXM_MPLS_TC_MASKED = 292,
    OF_OXM_SCTP_DST = 293,
    OF_OXM_SCTP_DST_MASKED = 294,
    OF_OXM_SCTP_SRC = 295,
    OF_OXM_SCTP_SRC_MASKED = 296,
    OF_OXM_TCP_DST = 297,
    OF_OXM_TCP_DST_MASKED = 298,
    OF_OXM_TCP_SRC = 299,
    OF_OXM_TCP_SRC_MASKED = 300,
    OF_OXM_UDP_DST = 301,
    OF_OXM_UDP_DST_MASKED = 302,
    OF_OXM_UDP_SRC = 303,
    OF_OXM_UDP_SRC_MASKED = 304,
    OF_OXM_VLAN_PCP = 305,
    OF_OXM_VLAN_PCP_MASKED = 306,
    OF_OXM_VLAN_VID = 307,
    OF_OXM_VLAN_VID_MASKED = 308,
    OF_PACKET_QUEUE = 309,
    OF_PORT_DESC = 310,
    OF_PORT_STATS_ENTRY = 311,
    OF_QUEUE_PROP = 312,
    OF_QUEUE_PROP_EXPERIMENTER = 313,
    OF_QUEUE_PROP_HEADER = 314,
    OF_QUEUE_PROP_MAX_RATE = 315,
    OF_QUEUE_PROP_MIN_RATE = 316,
    OF_QUEUE_STATS_ENTRY = 317,
    OF_TABLE_FEATURE_PROP = 318,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 319,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 320,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 321,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 322,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 323,
    OF_TABLE_FEATURE_PROP_HEADER = 324,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 325,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 326,
    OF_TABLE_FEATURE_PROP_MATCH = 327,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 328,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 329,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 330,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 331,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 332,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 333,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 334,
    OF_TABLE_FEATURES = 335,
    OF_TABLE_STATS_ENTRY = 336,
    OF_UINT32 = 337,
    OF_UINT8 = 338,

    /* List objects */
    OF_LIST_ACTION = 339,
    OF_LIST_ACTION_ID = 340,
    OF_LIST_BSN_INTERFACE = 341,
    OF_LIST_BUCKET = 342,
    OF_LIST_BUCKET_COUNTER = 343,
    OF_LIST_FLOW_STATS_ENTRY = 344,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 345,
    OF_LIST_GROUP_STATS_ENTRY = 346,
    OF_LIST_HELLO_ELEM = 347,
    OF_LIST_INSTRUCTION = 348,
    OF_LIST_METER_BAND = 349,
    OF_LIST_METER_BAND_STATS = 350,
    OF_LIST_METER_STATS = 351,
    OF_LIST_OXM = 352,
    OF_LIST_PACKET_QUEUE = 353,
    OF_LIST_PORT_DESC = 354,
    OF_LIST_PORT_STATS_ENTRY = 355,
    OF_LIST_QUEUE_PROP = 356,
    OF_LIST_QUEUE_STATS_ENTRY = 357,
    OF_LIST_TABLE_FEATURE_PROP = 358,
    OF_LIST_TABLE_FEATURES = 359,
    OF_LIST_TABLE_STATS_ENTRY = 360,
    OF_LIST_UINT32 = 361,
    OF_LIST_UINT8 = 362,
...
#define OF_MESSAGE_OBJECT_COUNT 124
