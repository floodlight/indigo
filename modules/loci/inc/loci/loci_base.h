...
typedef enum of_object_id_e {
    ...
    OF_BSN_HEADER = 22,
    OF_BSN_SET_IP_MASK = 23,
    OF_BSN_SET_L2_TABLE_REPLY = 24,
    OF_BSN_SET_L2_TABLE_REQUEST = 25,
    OF_BSN_SET_MIRRORING = 26,
    OF_BSN_SET_PKTIN_SUPPRESSION_REPLY = 27,
    OF_BSN_SET_PKTIN_SUPPRESSION_REQUEST = 28,
    OF_BSN_SHELL_COMMAND = 29,
    OF_BSN_SHELL_OUTPUT = 30,
    OF_BSN_SHELL_STATUS = 31,
    OF_BSN_VIRTUAL_PORT_CREATE_REPLY = 32,
    OF_BSN_VIRTUAL_PORT_CREATE_REQUEST = 33,
    OF_BSN_VIRTUAL_PORT_REMOVE_REPLY = 34,
    OF_BSN_VIRTUAL_PORT_REMOVE_REQUEST = 35,
    OF_DESC_STATS_REPLY = 36,
    OF_DESC_STATS_REQUEST = 37,
    OF_ECHO_REPLY = 38,
    OF_ECHO_REQUEST = 39,
    OF_ERROR_MSG = 40,
    OF_EXPERIMENTER = 41,
    OF_EXPERIMENTER_STATS_REPLY = 42,
    OF_EXPERIMENTER_STATS_REQUEST = 43,
    OF_FEATURES_REPLY = 44,
    OF_FEATURES_REQUEST = 45,
    OF_FLOW_ADD = 46,
    OF_FLOW_DELETE = 47,
    OF_FLOW_DELETE_STRICT = 48,
    OF_FLOW_MOD = 49,
    OF_FLOW_MODIFY = 50,
    OF_FLOW_MODIFY_STRICT = 51,
    OF_FLOW_REMOVED = 52,
    OF_FLOW_STATS_REPLY = 53,
    OF_FLOW_STATS_REQUEST = 54,
    OF_GET_CONFIG_REPLY = 55,
    OF_GET_CONFIG_REQUEST = 56,
    OF_GROUP_DESC_STATS_REPLY = 57,
    OF_GROUP_DESC_STATS_REQUEST = 58,
    OF_GROUP_FEATURES_STATS_REPLY = 59,
    OF_GROUP_FEATURES_STATS_REQUEST = 60,
    OF_GROUP_MOD = 61,
    OF_GROUP_STATS_REPLY = 62,
    OF_GROUP_STATS_REQUEST = 63,
    OF_HELLO = 64,
    OF_METER_CONFIG_STATS_REPLY = 65,
    OF_METER_CONFIG_STATS_REQUEST = 66,
    OF_METER_FEATURES_STATS_REPLY = 67,
    OF_METER_FEATURES_STATS_REQUEST = 68,
    OF_METER_MOD = 69,
    OF_METER_STATS_REPLY = 70,
    OF_METER_STATS_REQUEST = 71,
    OF_NICIRA_CONTROLLER_ROLE_REPLY = 72,
    OF_NICIRA_CONTROLLER_ROLE_REQUEST = 73,
    OF_NICIRA_HEADER = 74,
    OF_PACKET_IN = 75,
    OF_PACKET_OUT = 76,
    OF_PORT_DESC_STATS_REPLY = 77,
    OF_PORT_DESC_STATS_REQUEST = 78,
    OF_PORT_MOD = 79,
    OF_PORT_STATS_REPLY = 80,
    OF_PORT_STATS_REQUEST = 81,
    OF_PORT_STATUS = 82,
    OF_QUEUE_GET_CONFIG_REPLY = 83,
    OF_QUEUE_GET_CONFIG_REQUEST = 84,
    OF_QUEUE_STATS_REPLY = 85,
    OF_QUEUE_STATS_REQUEST = 86,
    OF_ROLE_REPLY = 87,
    OF_ROLE_REQUEST = 88,
    OF_SET_CONFIG = 89,
    OF_STATS_REPLY = 90,
    OF_STATS_REQUEST = 91,
    OF_TABLE_FEATURES_STATS_REPLY = 92,
    OF_TABLE_FEATURES_STATS_REQUEST = 93,
    OF_TABLE_MOD = 94,
    OF_TABLE_STATS_REPLY = 95,
    OF_TABLE_STATS_REQUEST = 96,

    /* Non-message objects */
    OF_ACTION = 97,
    OF_ACTION_BSN = 98,
    OF_ACTION_BSN_MIRROR = 99,
    OF_ACTION_BSN_SET_TUNNEL_DST = 100,
    OF_ACTION_COPY_TTL_IN = 101,
    OF_ACTION_COPY_TTL_OUT = 102,
    OF_ACTION_DEC_MPLS_TTL = 103,
    OF_ACTION_DEC_NW_TTL = 104,
    OF_ACTION_ENQUEUE = 105,
    OF_ACTION_EXPERIMENTER = 106,
    OF_ACTION_GROUP = 107,
    OF_ACTION_HEADER = 108,
    OF_ACTION_ID = 109,
    OF_ACTION_ID_BSN = 110,
    OF_ACTION_ID_BSN_MIRROR = 111,
    OF_ACTION_ID_BSN_SET_TUNNEL_DST = 112,
    OF_ACTION_ID_COPY_TTL_IN = 113,
    OF_ACTION_ID_COPY_TTL_OUT = 114,
    OF_ACTION_ID_DEC_MPLS_TTL = 115,
    OF_ACTION_ID_DEC_NW_TTL = 116,
    OF_ACTION_ID_EXPERIMENTER = 117,
    OF_ACTION_ID_GROUP = 118,
    OF_ACTION_ID_HEADER = 119,
    OF_ACTION_ID_NICIRA = 120,
    OF_ACTION_ID_NICIRA_DEC_TTL = 121,
    OF_ACTION_ID_OUTPUT = 122,
    OF_ACTION_ID_POP_MPLS = 123,
    OF_ACTION_ID_POP_PBB = 124,
    OF_ACTION_ID_POP_VLAN = 125,
    OF_ACTION_ID_PUSH_MPLS = 126,
    OF_ACTION_ID_PUSH_PBB = 127,
    OF_ACTION_ID_PUSH_VLAN = 128,
    OF_ACTION_ID_SET_FIELD = 129,
    OF_ACTION_ID_SET_MPLS_TTL = 130,
    OF_ACTION_ID_SET_NW_TTL = 131,
    OF_ACTION_ID_SET_QUEUE = 132,
    OF_ACTION_NICIRA = 133,
    OF_ACTION_NICIRA_DEC_TTL = 134,
    OF_ACTION_OUTPUT = 135,
    OF_ACTION_POP_MPLS = 136,
    OF_ACTION_POP_PBB = 137,
    OF_ACTION_POP_VLAN = 138,
    OF_ACTION_PUSH_MPLS = 139,
    OF_ACTION_PUSH_PBB = 140,
    OF_ACTION_PUSH_VLAN = 141,
    OF_ACTION_SET_DL_DST = 142,
    OF_ACTION_SET_DL_SRC = 143,
    OF_ACTION_SET_FIELD = 144,
    OF_ACTION_SET_MPLS_LABEL = 145,
    OF_ACTION_SET_MPLS_TC = 146,
    OF_ACTION_SET_MPLS_TTL = 147,
    OF_ACTION_SET_NW_DST = 148,
    OF_ACTION_SET_NW_ECN = 149,
    OF_ACTION_SET_NW_SRC = 150,
    OF_ACTION_SET_NW_TOS = 151,
    OF_ACTION_SET_NW_TTL = 152,
    OF_ACTION_SET_QUEUE = 153,
    OF_ACTION_SET_TP_DST = 154,
    OF_ACTION_SET_TP_SRC = 155,
    OF_ACTION_SET_VLAN_PCP = 156,
    OF_ACTION_SET_VLAN_VID = 157,
    OF_ACTION_STRIP_VLAN = 158,
    OF_BSN_INTERFACE = 159,
    OF_BSN_VPORT = 160,
    OF_BSN_VPORT_HEADER = 161,
    OF_BSN_VPORT_Q_IN_Q = 162,
    OF_BUCKET = 163,
    OF_BUCKET_COUNTER = 164,
    OF_EXPERIMENTER_MULTIPART_HEADER = 165,
    OF_FLOW_STATS_ENTRY = 166,
    OF_GROUP_DESC_STATS_ENTRY = 167,
    OF_GROUP_STATS_ENTRY = 168,
    OF_HEADER = 169,
    OF_HELLO_ELEM = 170,
    OF_HELLO_ELEM_HEADER = 171,
    OF_HELLO_ELEM_VERSIONBITMAP = 172,
    OF_INSTRUCTION = 173,
    OF_INSTRUCTION_APPLY_ACTIONS = 174,
    OF_INSTRUCTION_CLEAR_ACTIONS = 175,
    OF_INSTRUCTION_EXPERIMENTER = 176,
    OF_INSTRUCTION_GOTO_TABLE = 177,
    OF_INSTRUCTION_HEADER = 178,
    OF_INSTRUCTION_METER = 179,
    OF_INSTRUCTION_WRITE_ACTIONS = 180,
    OF_INSTRUCTION_WRITE_METADATA = 181,
    OF_MATCH_V1 = 182,
    OF_MATCH_V2 = 183,
    OF_MATCH_V3 = 184,
    OF_METER_BAND = 185,
    OF_METER_BAND_DROP = 186,
    OF_METER_BAND_DSCP_REMARK = 187,
    OF_METER_BAND_EXPERIMENTER = 188,
    OF_METER_BAND_HEADER = 189,
    OF_METER_BAND_STATS = 190,
    OF_METER_CONFIG = 191,
    OF_METER_FEATURES = 192,
    OF_METER_STATS = 193,
    OF_OXM = 194,
    OF_OXM_ARP_OP = 195,
    OF_OXM_ARP_OP_MASKED = 196,
    OF_OXM_ARP_SHA = 197,
    OF_OXM_ARP_SHA_MASKED = 198,
    OF_OXM_ARP_SPA = 199,
    OF_OXM_ARP_SPA_MASKED = 200,
    OF_OXM_ARP_THA = 201,
    OF_OXM_ARP_THA_MASKED = 202,
    OF_OXM_ARP_TPA = 203,
    OF_OXM_ARP_TPA_MASKED = 204,
    OF_OXM_ETH_DST = 205,
    OF_OXM_ETH_DST_MASKED = 206,
    OF_OXM_ETH_SRC = 207,
    OF_OXM_ETH_SRC_MASKED = 208,
    OF_OXM_ETH_TYPE = 209,
    OF_OXM_ETH_TYPE_MASKED = 210,
    OF_OXM_HEADER = 211,
    OF_OXM_ICMPV4_CODE = 212,
    OF_OXM_ICMPV4_CODE_MASKED = 213,
    OF_OXM_ICMPV4_TYPE = 214,
    OF_OXM_ICMPV4_TYPE_MASKED = 215,
    OF_OXM_ICMPV6_CODE = 216,
    OF_OXM_ICMPV6_CODE_MASKED = 217,
    OF_OXM_ICMPV6_TYPE = 218,
    OF_OXM_ICMPV6_TYPE_MASKED = 219,
    OF_OXM_IN_PHY_PORT = 220,
    OF_OXM_IN_PHY_PORT_MASKED = 221,
    OF_OXM_IN_PORT = 222,
    OF_OXM_IN_PORT_MASKED = 223,
    OF_OXM_IP_DSCP = 224,
    OF_OXM_IP_DSCP_MASKED = 225,
    OF_OXM_IP_ECN = 226,
    OF_OXM_IP_ECN_MASKED = 227,
    OF_OXM_IP_PROTO = 228,
    OF_OXM_IP_PROTO_MASKED = 229,
    OF_OXM_IPV4_DST = 230,
    OF_OXM_IPV4_DST_MASKED = 231,
    OF_OXM_IPV4_SRC = 232,
    OF_OXM_IPV4_SRC_MASKED = 233,
    OF_OXM_IPV6_DST = 234,
    OF_OXM_IPV6_DST_MASKED = 235,
    OF_OXM_IPV6_FLABEL = 236,
    OF_OXM_IPV6_FLABEL_MASKED = 237,
    OF_OXM_IPV6_ND_SLL = 238,
    OF_OXM_IPV6_ND_SLL_MASKED = 239,
    OF_OXM_IPV6_ND_TARGET = 240,
    OF_OXM_IPV6_ND_TARGET_MASKED = 241,
    OF_OXM_IPV6_ND_TLL = 242,
    OF_OXM_IPV6_ND_TLL_MASKED = 243,
    OF_OXM_IPV6_SRC = 244,
    OF_OXM_IPV6_SRC_MASKED = 245,
    OF_OXM_METADATA = 246,
    OF_OXM_METADATA_MASKED = 247,
    OF_OXM_MPLS_LABEL = 248,
    OF_OXM_MPLS_LABEL_MASKED = 249,
    OF_OXM_MPLS_TC = 250,
    OF_OXM_MPLS_TC_MASKED = 251,
    OF_OXM_SCTP_DST = 252,
    OF_OXM_SCTP_DST_MASKED = 253,
    OF_OXM_SCTP_SRC = 254,
    OF_OXM_SCTP_SRC_MASKED = 255,
    OF_OXM_TCP_DST = 256,
    OF_OXM_TCP_DST_MASKED = 257,
    OF_OXM_TCP_SRC = 258,
    OF_OXM_TCP_SRC_MASKED = 259,
    OF_OXM_UDP_DST = 260,
    OF_OXM_UDP_DST_MASKED = 261,
    OF_OXM_UDP_SRC = 262,
    OF_OXM_UDP_SRC_MASKED = 263,
    OF_OXM_VLAN_PCP = 264,
    OF_OXM_VLAN_PCP_MASKED = 265,
    OF_OXM_VLAN_VID = 266,
    OF_OXM_VLAN_VID_MASKED = 267,
    OF_PACKET_QUEUE = 268,
    OF_PORT_DESC = 269,
    OF_PORT_STATS_ENTRY = 270,
    OF_QUEUE_PROP = 271,
    OF_QUEUE_PROP_EXPERIMENTER = 272,
    OF_QUEUE_PROP_HEADER = 273,
    OF_QUEUE_PROP_MAX_RATE = 274,
    OF_QUEUE_PROP_MIN_RATE = 275,
    OF_QUEUE_STATS_ENTRY = 276,
    OF_TABLE_FEATURE_PROP = 277,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 278,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 279,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 280,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 281,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 282,
    OF_TABLE_FEATURE_PROP_HEADER = 283,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 284,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 285,
    OF_TABLE_FEATURE_PROP_MATCH = 286,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 287,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 288,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 289,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 290,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 291,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 292,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 293,
    OF_TABLE_FEATURES = 294,
    OF_TABLE_STATS_ENTRY = 295,
    OF_UINT32 = 296,
    OF_UINT8 = 297,

    /* List objects */
    OF_LIST_ACTION = 298,
    OF_LIST_ACTION_ID = 299,
    OF_LIST_BSN_INTERFACE = 300,
    OF_LIST_BUCKET = 301,
    OF_LIST_BUCKET_COUNTER = 302,
    OF_LIST_FLOW_STATS_ENTRY = 303,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 304,
    OF_LIST_GROUP_STATS_ENTRY = 305,
    OF_LIST_HELLO_ELEM = 306,
    OF_LIST_INSTRUCTION = 307,
    OF_LIST_METER_BAND = 308,
    OF_LIST_METER_BAND_STATS = 309,
    OF_LIST_METER_STATS = 310,
    OF_LIST_OXM = 311,
    OF_LIST_PACKET_QUEUE = 312,
    OF_LIST_PORT_DESC = 313,
    OF_LIST_PORT_STATS_ENTRY = 314,
    OF_LIST_QUEUE_PROP = 315,
    OF_LIST_QUEUE_STATS_ENTRY = 316,
    OF_LIST_TABLE_FEATURE_PROP = 317,
    OF_LIST_TABLE_FEATURES = 318,
    OF_LIST_TABLE_STATS_ENTRY = 319,
    OF_LIST_UINT32 = 320,
    OF_LIST_UINT8 = 321,
...
#define OF_MESSAGE_OBJECT_COUNT 97
