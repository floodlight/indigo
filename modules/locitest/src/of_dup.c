...
/**
 * Duplicate an object of type of_bsn_set_l2_table
 * using accessor functions
 * @param src Pointer to object to be duplicated
 * @returns A new object of type of_bsn_set_l2_table.
 *
 * The caller is responsible for deleting the returned value
 */
of_bsn_set_l2_table_t *
of_bsn_set_l2_table_OF_VERSION_1_0_dup(
    of_bsn_set_l2_table_t *src)
{
    of_bsn_set_l2_table_t *dst;
    uint32_t val32;
    uint8_t val8;
    uint16_t val16;

    if ((dst = of_bsn_set_l2_table_new(src->version)) == NULL) {
        return NULL;
    }

    of_bsn_set_l2_table_xid_get(src, &val32);
    of_bsn_set_l2_table_xid_set(dst, val32);

    of_bsn_set_l2_table_experimenter_get(src, &val32);
    of_bsn_set_l2_table_experimenter_set(dst, val32);

    of_bsn_set_l2_table_subtype_get(src, &val32);
    of_bsn_set_l2_table_subtype_set(dst, val32);

    of_bsn_set_l2_table_l2_table_enable_get(src, &val8);
    of_bsn_set_l2_table_l2_table_enable_set(dst, val8);

    of_bsn_set_l2_table_l2_table_priority_get(src, &val16);
    of_bsn_set_l2_table_l2_table_priority_set(dst, val16);
...
/**
 * Duplicate an object of type of_bsn_set_pktin_suppression
 * using accessor functions
 * @param src Pointer to object to be duplicated
 * @returns A new object of type of_bsn_set_pktin_suppression.
 *
 * The caller is responsible for deleting the returned value
 */
...
{
    of_bsn_set_pktin_suppression_t *dst;
    uint32_t val32;
    uint8_t val8;
    uint16_t val16;
    uint64_t val64;

    if ((dst = of_bsn_set_pktin_suppression_new(src->version)) == NULL) {
        return NULL;
    }

    of_bsn_set_pktin_suppression_xid_get(src, &val32);
    of_bsn_set_pktin_suppression_xid_set(dst, val32);

    of_bsn_set_pktin_suppression_experimenter_get(src, &val32);
    of_bsn_set_pktin_suppression_experimenter_set(dst, val32);

    of_bsn_set_pktin_suppression_subtype_get(src, &val32);
    of_bsn_set_pktin_suppression_subtype_set(dst, val32);

    of_bsn_set_pktin_suppression_enabled_get(src, &val8);
    of_bsn_set_pktin_suppression_enabled_set(dst, val8);

    of_bsn_set_pktin_suppression_idle_timeout_get(src, &val16);
    of_bsn_set_pktin_suppression_idle_timeout_set(dst, val16);

    of_bsn_set_pktin_suppression_hard_timeout_get(src, &val16);
    of_bsn_set_pktin_suppression_hard_timeout_set(dst, val16);

    of_bsn_set_pktin_suppression_priority_get(src, &val16);
    of_bsn_set_pktin_suppression_priority_set(dst, val16);

    of_bsn_set_pktin_suppression_cookie_get(src, &val64);
    of_bsn_set_pktin_suppression_cookie_set(dst, val64);
    ...
    of_error_msg_t *src)
{
    ...
    of_error_msg_err_type_get(src, &val16);
    of_error_msg_err_type_set(dst, val16);

    of_error_msg_code_get(src, &val16);
    of_error_msg_code_set(dst, val16);

    of_error_msg_data_get(src, &octets);
    of_error_msg_data_set(dst, &octets);
    ...
    of_bsn_interface_t *src)
{
    ...
    of_bsn_interface_ipv4_addr_get(src, &val32);
    of_bsn_interface_ipv4_addr_set(dst, val32);

    of_bsn_interface_ipv4_netmask_get(src, &val32);
    of_bsn_interface_ipv4_netmask_set(dst, val32);
    ...
    of_match_v1_t *src)
{
    ...
    of_match_v1_ipv4_src_get(src, &val32);
    of_match_v1_ipv4_src_set(dst, val32);

    of_match_v1_ipv4_dst_get(src, &val32);
    of_match_v1_ipv4_dst_set(dst, val32);
    ...
    of_match_v2_t *src)
{
    ...
    of_match_v2_ipv4_src_get(src, &val32);
    of_match_v2_ipv4_src_set(dst, val32);

    of_match_v2_ipv4_src_mask_get(src, &val32);
    of_match_v2_ipv4_src_mask_set(dst, val32);

    of_match_v2_ipv4_dst_get(src, &val32);
    of_match_v2_ipv4_dst_set(dst, val32);

    of_match_v2_ipv4_dst_mask_get(src, &val32);
    of_match_v2_ipv4_dst_mask_set(dst, val32);
...
/**
 * Duplicate an object of type of_oxm_experimenter_header
 * using accessor functions
 * @param src Pointer to object to be duplicated
 * @returns A new object of type of_oxm_experimenter_header.
 *
 * The caller is responsible for deleting the returned value
 */
of_oxm_experimenter_header_t *
of_oxm_experimenter_header_OF_VERSION_1_2_dup(
    of_oxm_experimenter_header_t *src)
{
    of_oxm_experimenter_header_t *dst;
    uint32_t val32;
    of_octets_t octets;

    if ((dst = of_oxm_experimenter_header_new(src->version)) == NULL) {
        return NULL;
    }

    of_oxm_experimenter_header_oxm_header_get(src, &val32);
    of_oxm_experimenter_header_oxm_header_set(dst, val32);

    of_oxm_experimenter_header_experimenter_get(src, &val32);
    of_oxm_experimenter_header_experimenter_set(dst, val32);

    of_oxm_experimenter_header_data_get(src, &octets);
    of_oxm_experimenter_header_data_set(dst, &octets);
    ...
    of_oxm_ipv4_dst_t *src)
{
    ...
    of_oxm_ipv4_dst_value_get(src, &val32);
    of_oxm_ipv4_dst_value_set(dst, val32);
    ...
    of_oxm_ipv4_dst_masked_t *src)
{
    ...
    of_oxm_ipv4_dst_masked_value_get(src, &val32);
    of_oxm_ipv4_dst_masked_value_set(dst, val32);

    of_oxm_ipv4_dst_masked_value_mask_get(src, &val32);
    of_oxm_ipv4_dst_masked_value_mask_set(dst, val32);
    ...
    of_oxm_ipv4_src_t *src)
{
    ...
    of_oxm_ipv4_src_value_get(src, &val32);
    of_oxm_ipv4_src_value_set(dst, val32);
    ...
    of_oxm_ipv4_src_masked_t *src)
{
    ...
    of_oxm_ipv4_src_masked_value_get(src, &val32);
    of_oxm_ipv4_src_masked_value_set(dst, val32);

    of_oxm_ipv4_src_masked_value_mask_get(src, &val32);
    of_oxm_ipv4_src_masked_value_mask_set(dst, val32);
...
/**
 * Duplicate an object of type of_experimenter_multipart_header
 * using accessor functions
 * @param src Pointer to object to be duplicated
 * @returns A new object of type of_experimenter_multipart_header.
 *
 * The caller is responsible for deleting the returned value
 */
...
{
    of_experimenter_multipart_header_t *dst;
    uint32_t val32;

    if ((dst = of_experimenter_multipart_header_new(src->version)) == NULL) {
        return NULL;
    }

    of_experimenter_multipart_header_experimenter_get(src, &val32);
    of_experimenter_multipart_header_experimenter_set(dst, val32);

    of_experimenter_multipart_header_subtype_get(src, &val32);
    of_experimenter_multipart_header_subtype_set(dst, val32);
    ...
    of_bsn_set_l2_table_t *src)
{
    ...
    if (src->version == OF_VERSION_1_0) {
        return of_bsn_set_l2_table_OF_VERSION_1_0_dup(src);
    }
    ...
    of_bsn_set_pktin_suppression_t *src)
{
    ...
    if (src->version == OF_VERSION_1_0) {
        return of_bsn_set_pktin_suppression_OF_VERSION_1_0_dup(src);
    }

    if (src->version == OF_VERSION_1_1) {
        return of_bsn_set_pktin_suppression_OF_VERSION_1_1_dup(src);
    }

    if (src->version == OF_VERSION_1_2) {
        return of_bsn_set_pktin_suppression_OF_VERSION_1_2_dup(src);
    }

    if (src->version == OF_VERSION_1_3) {
        return of_bsn_set_pktin_suppression_OF_VERSION_1_3_dup(src);
    }
    ...
    of_experimenter_multipart_header_t *src)
{
    ...
    if (src->version == OF_VERSION_1_3) {
        return of_experimenter_multipart_header_OF_VERSION_1_3_dup(src);
    }
    ...
    of_oxm_experimenter_header_t *src)
{
    ...
    if (src->version == OF_VERSION_1_2) {
        return of_oxm_experimenter_header_OF_VERSION_1_2_dup(src);
    }

    if (src->version == OF_VERSION_1_3) {
        return of_oxm_experimenter_header_OF_VERSION_1_3_dup(src);
    }
